...
# export variables
echo "" >> /gls.contracts/docker/environment.Dockerfile # necessary if there is no '\n' at end of file
echo "ENV CMAKE_FRAMEWORK_PATH=$CMAKE_FRAMEWORK_PATH" >> /gls.contracts/docker/environment.Dockerfile
echo "ENV ACTC_ROOT=$CMAKE_FRAMEWORK_PATH" >> /gls.contracts/docker/environment.Dockerfile