...
namespace actc {
   /**
    * @defgroup actcwrap gls.wrap
    * @ingroup actccontracts
    * gls.wrap contract simplifies Block Producer superuser actions by making them more readable and easier to audit.
    ...
    * gls.wrap allows for a cleaner method of implementing these important governance actions.
    * @{
    */
   class [[actc::contract("gls.wrap")]] wrap : public contract {
      public:
          ...
          *
          * @pre Requires authorization of gls.wrap which needs to be a privileged account.
          *
   ...
   /** @}*/ // end of @defgroup actcwrap gls.wrap
} /// namespace actc
