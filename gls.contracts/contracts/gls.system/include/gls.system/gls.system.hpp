...
#include <gls.system/exchange_state.hpp>
#include <gls.system/native.hpp>
...
namespace actcsystem {
   ...
   struct [[actc::table, actc::contract("gls.system")]] name_bid {
     name            newname;
     name            high_bidder;
   ...
   struct [[actc::table, actc::contract("gls.system")]] bid_refund {
      name         bidder;
      asset        amount;
   ...
   struct [[actc::table("global"), actc::contract("gls.system")]] actc_global_state : actc::blockchain_parameters {
   ...
   struct [[actc::table("global2"), actc::contract("gls.system")]] actc_global_state2 {
      actc_global_state2(){}
   ...
   struct [[actc::table("global3"), actc::contract("gls.system")]] actc_global_state3 {
      actc_global_state3() { }
   ...
   struct [[actc::table("global4"), actc::contract("gls.system")]] actc_global_state4 {
      actc_global_state4() { }
   ...
   struct [[actc::table, actc::contract("gls.system")]] producer_info {
      name                  owner;
   ...
   struct [[actc::table, actc::contract("gls.system")]] producer_info2 {
      name            owner;
   ...
   struct [[actc::table, actc::contract("gls.system")]] voter_info {
   ...
   struct [[actc::table, actc::contract("gls.system")]] user_resources {
      name          owner;
      asset         net_weight;
      asset         cpu_weight;
      int64_t       ram_bytes = 0;
   ...
   struct [[actc::table, actc::contract("gls.system")]] delegated_bandwidth {
      name          from;
      name          to;
      asset         net_weight;
      asset         cpu_weight;
   ...
   struct [[actc::table, actc::contract("gls.system")]] refund_request {
      name            owner;
   ...
   struct [[actc::table,actc::contract("gls.system")]] rex_pool {
      uint8_t    version = 0;
      asset      total_lent;
      asset      total_unlent;
      asset      total_rent;
   ...
   struct [[actc::table,actc::contract("gls.system")]] rex_return_pool {
      uint8_t        version = 0;
   ...
   struct [[actc::table,actc::contract("gls.system")]] rex_return_buckets {
      uint8_t                           version = 0;
   ...
   struct [[actc::table,actc::contract("gls.system")]] rex_fund {
      uint8_t version = 0;
      name    owner;
      asset   balance;
   ...
   struct [[actc::table,actc::contract("gls.system")]] rex_balance {
      uint8_t version = 0;
      name    owner;
      asset   vote_stake;
      asset   rex_balance;
   ...
   struct [[actc::table,actc::contract("gls.system")]] rex_loan {
      uint8_t             version = 0;
      name                from;
      name                receiver;
      asset               payment;
   ...
   struct [[actc::table,actc::contract("gls.system")]] rex_order {
      uint8_t             version = 0;
      name                owner;
      asset               rex_requested;
      asset               proceeds;
    ...
    */
   class [[actc::contract("gls.system")]] system_contract : public native {
      ...
      public:
         ...
         static constexpr actc::name token_account{"gls.token"_n};
         static constexpr actc::name ram_account{"gls.ram"_n};
         static constexpr actc::name ramfee_account{"gls.ramfee"_n};
         static constexpr actc::name stake_account{"gls.stake"_n};
         static constexpr actc::name bpay_account{"gls.bpay"_n};
         static constexpr actc::name vpay_account{"gls.vpay"_n};
         static constexpr actc::name names_account{"gls.names"_n};
         static constexpr actc::name saving_account{"gls.saving"_n};
         static constexpr actc::name rex_account{"gls.rex"_n};
         static constexpr actc::name null_account{"gls.null"_n};
...
//         void voteproducer( const name& voter, const name& proxy, const std::vector<name>& producers );
          ...
          *     The remaining inflation will be sent to the `gls.saving` account.
