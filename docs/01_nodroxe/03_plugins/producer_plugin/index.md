...
```console
# config.ini
plugin = roxe::producer_plugin [options]
```
```sh
...
```console
Config Options for roxe::producer_plugin:
  ...
  --private-key arg                     (DEPRECATED - Use signature-provider 
                                        ...
                                        times)
  --signature-provider arg (=ROXE6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV=KEY:5KQwrPbwdL6PhXujxW37FSSQZ1JiwsST4cqQzDeyXtP79zkvFD3)
                                        ...
                                        Where:
                                           ...
                                           KROXED:<data>    is the URL where 
                                                           kroxed is available 
                                                           and the approptiate 
                                                           wallet(s) are 
                                                           unlocked
  --kroxed-provider-timeout arg (=5)     Limits the maximum time (in 
                                        milliseconds) that is allowed for 
                                        sending blocks to a kroxed provider for 
                                        signing
