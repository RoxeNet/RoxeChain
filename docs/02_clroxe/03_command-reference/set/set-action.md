...
```console
Usage: clroxe set action [OPTIONS] SUBCOMMAND
...
clroxe set action permission sandwichfarm roxe.system voteproducer voting -p sandwichfarm@voting

#Now can execute the transaction with the previously set permissions. 
clroxe system voteproducer approve sandwichfarm someproducer -p sandwichfarm@voting
```
