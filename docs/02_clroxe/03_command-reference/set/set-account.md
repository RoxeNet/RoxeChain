...
`--add-code` [code] add 'roxe.code' permission to specified permission authority

`--remove-code` [code] remove 'roxe.code' permission from specified permission authority
...
```sh
clroxe set account permission test active '{"threshold" : 1, "keys" : [{"permission":{"key":"ROXE8X7Mp7apQWtL6T2sfSZzBcQNUqZB7tARFEm9gA9Tn9nbMdsvBB","permission":"active"},"weight":1}], "accounts" : [{"permission":{"account":"acc2","permission":"active"},"weight":50}]}' owner
```
...
```sh
clroxe set account permission test active '{"threshold" : 1, "keys" : [], "accounts" : [{"permission":{"account":"sandwich","permission":"active"},"weight":1},{"permission":{"account":"acc1","permission":"active"},"weight":50}]}' owner
```
The third example demonstrates how to setup permissions for multisig.

```sh
clroxe set account permission test active '{"threshold" : 100, "keys" : [{"permission":{"key":"ROXE8X7Mp7apQWtL6T2sfSZzBcQNUqZB7tARFEm9gA9Tn9nbMdsvBB","permission":"active"},"weight":25}], "accounts" : [{"permission":{"account":"@sandwich","permission":"active"},"weight":75}]}' owner
```
...
```json
{
  ...
  "keys"            : [],     /*An array made up of individual permissions defined with an ROXE PUBLIC KEY*/
  "accounts"        : []      /*An array made up of individual permissions defined with an ROXE ACCOUNT*/
}
```
...
{
  "permission" : {
    "key"           : "ROXE8X7Mp7apQWtL6T2sfSZzBcQNUqZB7tARFEm9gA9Tn9nbMdsvBB",
    "permission"    : "active"
  },
