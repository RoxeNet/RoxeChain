...
### Get formatted data for user **roxe**

```sh
clroxe get account roxe
```
```console
privileged: true
permissions: 
...
producers:     <not voted>
```
### Get JSON data for user **roxe**

```sh
clroxe get account roxe --json
```
```json
{
  "account_name": "roxe",
  ...
  "permissions": [{
      ...
      "required_auth": {
        "threshold": 1,
        "keys": [{
            "key": "ROXE6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV",
            "weight": 1
          }
        ],
        "accounts": [],
