...
## Command
A set of ROXE keys is required to create an account. The ROXE keys can be generated by using `clroxe create key`.

```sh
clroxe create account inita tester ROXE4toFS3YXEQCkuuw1aqDLrtHim86Gz9u3hBdcBw5KNPZcursVHq ROXE7d9A3uLe6As66jzN8j44TXJUqJSK3bFjjEEqR4oTvNAB3iM9SA
```
