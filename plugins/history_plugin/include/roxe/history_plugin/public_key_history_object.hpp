...
CHAINBASE_SET_INDEX_TYPE( roxe::public_key_history_object, roxe::public_key_history_multi_index )

FC_REFLECT( roxe::public_key_history_object, (public_key)(name)(permission) )
