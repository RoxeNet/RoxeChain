...
CHAINBASE_SET_INDEX_TYPE( roxe::account_control_history_object, roxe::account_control_history_multi_index )

FC_REFLECT( roxe::account_control_history_object, (controlled_account)(controlled_permission)(controlling_account) )
