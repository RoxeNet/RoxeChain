...
#include <roxe/wallet_plugin/wallet_api.hpp>
...
class soft_wallet final : public wallet_api
{
   public:
       ...
       *
       * example: remove_key ROXE7MVh6bachyhuHm1rTN5n3mwSpQh1VFELNUcGKVdG3GxXYELUDt
       *
...
FC_REFLECT( roxe::wallet::wallet_data, (cipher_keys) )

FC_REFLECT( roxe::wallet::plain_keys, (checksum)(keys) )
