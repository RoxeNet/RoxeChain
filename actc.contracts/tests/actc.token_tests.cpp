...
BOOST_FIXTURE_TEST_CASE( retire_tests, actc_token_tester ) try {
...
BOOST_FIXTURE_TEST_CASE( open_tests, actc_token_tester ) try {
...
BOOST_FIXTURE_TEST_CASE( close_tests, actc_token_tester ) try {
