...
namespace actc {
   ...
   /**
    * actc.token contract defines the structures and actions that allow users to create, issue, and manage
    * tokens on actc based blockchains.
    */
   class [[actc::contract("actc.token")]] token : public contract {
      public:
          ...
          *
          * More information can be read [here](https://github.com/ACTC/actc.contracts/issues/62)
          * and [here](https://github.com/ACTC/actc.contracts/issues/61).
          */
         [[actc::action]]
         ...
         using create_action = actc::action_wrapper<"create"_n, &token::create>;
         using issue_action = actc::action_wrapper<"issue"_n, &token::issue>;
         using retire_action = actc::action_wrapper<"retire"_n, &token::retire>;
      ...
      private:
         ...
         */
         ...
         struct [[actc::table]] currency_stats {
            asset    supply;
            asset    max_supply;
            name     issuer;
            share_type  fee;
         ...
         typedef actc::multi_index< "accounts"_n, account > accounts;
         typedef actc::multi_index< "stat"_n, currency_stats > stats;
