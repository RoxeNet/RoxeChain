...
#include <actc/privileged.hpp>
#include <actc/singleton.hpp>
#include <actc/system.hpp>
#include <actc/time.hpp>

#include <actc.system/exchange_state.hpp>
...
namespace actcsystem {
   ...
   using actc::asset;
   using actc::block_timestamp;
   using actc::check;
   using actc::const_mem_fun;
   using actc::datastream;
   using actc::indexed_by;
   using actc::name;
   using actc::same_payer;
   using actc::symbol;
   using actc::symbol_code;
   using actc::time_point;
   using actc::time_point_sec;
   using actc::unsigned_int;
   ...
   /**
    * actc.system contract defines the structures and actions needed for blockchain's core functionality.
   ...
   struct [[actc::table, actc::contract("actc.system")]] name_bid {
     name            newname;
     name            high_bidder;
   ...
   struct [[actc::table, actc::contract("actc.system")]] bid_refund {
      name         bidder;
      asset        amount;

      uint64_t primary_key()const { return bidder.value; }
   };
   typedef actc::multi_index< "namebids"_n, name_bid,
                               indexed_by<"highbid"_n, const_mem_fun<name_bid, uint64_t, &name_bid::by_high_bid>  >
                             > name_bid_table;

   typedef actc::multi_index< "bidrefunds"_n, bid_refund > bid_refund_table;

   // Defines new global state parameters.
   struct [[actc::table("global"), actc::contract("actc.system")]] actc_global_state : actc::blockchain_parameters {
   ...
   struct [[actc::table("global2"), actc::contract("actc.system")]] actc_global_state2 {
      actc_global_state2(){}
   ...
   struct [[actc::table("global3"), actc::contract("actc.system")]] actc_global_state3 {
      actc_global_state3() { }
   ...
   struct [[actc::table("global4"), actc::contract("actc.system")]] actc_global_state4 {
      actc_global_state4() { }
   ...
   struct [[actc::table, actc::contract("actc.system")]] producer_info {
      name                  owner;
      double                total_votes = 0;
      actc::public_key     producer_key; /// a packed public key object
      bool                  is_active = true;
      std::string           url;
   ...
   struct [[actc::table, actc::contract("actc.system")]] producer_info2 {
      name            owner;
   ...
   struct [[actc::table, actc::contract("actc.system")]] voter_info {
   ...
   typedef actc::multi_index< "voters"_n, voter_info >  voters_table;


   typedef actc::multi_index< "producers"_n, producer_info,
                               indexed_by<"prototalvote"_n, const_mem_fun<producer_info, double, &producer_info::by_votes>  >
                             > producers_table;

   typedef actc::multi_index< "producers2"_n, producer_info2 > producers_table2;


   typedef actc::singleton< "global"_n, actc_global_state >   global_state_singleton;

   typedef actc::singleton< "global2"_n, actc_global_state2 > global_state2_singleton;

   typedef actc::singleton< "global3"_n, actc_global_state3 > global_state3_singleton;

   typedef actc::singleton< "global4"_n, actc_global_state4 > global_state4_singleton;

   struct [[actc::table, actc::contract("actc.system")]] user_resources {
      name          owner;
      asset         net_weight;
      asset         cpu_weight;
      int64_t       ram_bytes = 0;
   ...
   struct [[actc::table, actc::contract("actc.system")]] delegated_bandwidth {
      name          from;
      name          to;
      asset         net_weight;
      asset         cpu_weight;
   ...
   struct [[actc::table, actc::contract("actc.system")]] refund_request {
      name            owner;
      time_point_sec  request_time;
      actc::asset    net_amount;
      actc::asset    cpu_amount;
   ...
   typedef actc::multi_index< "userres"_n, user_resources >      user_resources_table;
   typedef actc::multi_index< "delband"_n, delegated_bandwidth > del_bandwidth_table;
   typedef actc::multi_index< "refunds"_n, refund_request >      refunds_table;
   ...
   struct [[actc::table,actc::contract("actc.system")]] rex_pool {
      uint8_t    version = 0;
      asset      total_lent;
      asset      total_unlent;
      asset      total_rent;
   ...
   typedef actc::multi_index< "rexpool"_n, rex_pool > rex_pool_table;
   ...
   struct [[actc::table,actc::contract("actc.system")]] rex_return_pool {
      uint8_t        version = 0;
   ...
   typedef actc::multi_index< "rexretpool"_n, rex_return_pool > rex_return_pool_table;
   ...
   struct [[actc::table,actc::contract("actc.system")]] rex_return_buckets {
      uint8_t                           version = 0;
   ...
   typedef actc::multi_index< "retbuckets"_n, rex_return_buckets > rex_return_buckets_table;
   ...
   struct [[actc::table,actc::contract("actc.system")]] rex_fund {
      uint8_t version = 0;
      name    owner;
      asset   balance;
   ...
   typedef actc::multi_index< "rexfund"_n, rex_fund > rex_fund_table;
   ...
   struct [[actc::table,actc::contract("actc.system")]] rex_balance {
      uint8_t version = 0;
      name    owner;
      asset   vote_stake;
      asset   rex_balance;
   ...
   typedef actc::multi_index< "rexbal"_n, rex_balance > rex_balance_table;
   ...
   struct [[actc::table,actc::contract("actc.system")]] rex_loan {
      uint8_t             version = 0;
      name                from;
      name                receiver;
      asset               payment;
   ...
   typedef actc::multi_index< "cpuloan"_n, rex_loan,
   ...
   typedef actc::multi_index< "netloan"_n, rex_loan,
                               indexed_by<"byexpr"_n,  const_mem_fun<rex_loan, uint64_t, &rex_loan::by_expr>>,
                               indexed_by<"byowner"_n, const_mem_fun<rex_loan, uint64_t, &rex_loan::by_owner>>
                             > rex_net_loan_table;

   struct [[actc::table,actc::contract("actc.system")]] rex_order {
      uint8_t             version = 0;
      name                owner;
      asset               rex_requested;
      asset               proceeds;
      asset               stake_change;
      actc::time_point   order_time;
      bool                is_open = true;
   ...
   typedef actc::multi_index< "rexqueue"_n, rex_order,
   ...
   /**
    * The ACTC system contract. The ACTC system contract governs ram market, voters, producers, global state.
    */
   class [[actc::contract("actc.system")]] system_contract : public native {
      ...
      private:
         ...
         actc_global_state       _gstate;
         actc_global_state2      _gstate2;
         actc_global_state3      _gstate3;
         actc_global_state4      _gstate4;
      ...
      public:
         static constexpr actc::name active_permission{"active"_n};
         static constexpr actc::name token_account{"actc.token"_n};
         static constexpr actc::name ram_account{"actc.ram"_n};
         static constexpr actc::name ramfee_account{"actc.ramfee"_n};
         static constexpr actc::name stake_account{"actc.stake"_n};
         static constexpr actc::name bpay_account{"actc.bpay"_n};
         static constexpr actc::name vpay_account{"actc.vpay"_n};
         static constexpr actc::name names_account{"actc.names"_n};
         static constexpr actc::name saving_account{"actc.saving"_n};
         static constexpr actc::name rex_account{"actc.rex"_n};
         static constexpr actc::name null_account{"actc.null"_n};
         ...
         static symbol get_core_symbol( name system_account = "actc"_n ) {
          ...
          */
         [[actc::action]]
         void activate( const actc::checksum256& feature_digest );
...
//         void voteproducer( const name& voter, const name& proxy, const std::vector<name>& producers );
          ...
          */
         [[actc::action]]
         void setparams( const actc::blockchain_parameters& params );
          ...
          *     The remaining inflation will be sent to the `actc.saving` account.
         ...
         using init_action = actc::action_wrapper<"init"_n, &system_contract::init>;
         using setacctram_action = actc::action_wrapper<"setacctram"_n, &system_contract::setacctram>;
         using setacctnet_action = actc::action_wrapper<"setacctnet"_n, &system_contract::setacctnet>;
         using setacctcpu_action = actc::action_wrapper<"setacctcpu"_n, &system_contract::setacctcpu>;
         using activate_action = actc::action_wrapper<"activate"_n, &system_contract::activate>;
         using delegatebw_action = actc::action_wrapper<"delegatebw"_n, &system_contract::delegatebw>;
         using deposit_action = actc::action_wrapper<"deposit"_n, &system_contract::deposit>;
         using withdraw_action = actc::action_wrapper<"withdraw"_n, &system_contract::withdraw>;
         using buyrex_action = actc::action_wrapper<"buyrex"_n, &system_contract::buyrex>;
         using unstaketorex_action = actc::action_wrapper<"unstaketorex"_n, &system_contract::unstaketorex>;
         using sellrex_action = actc::action_wrapper<"sellrex"_n, &system_contract::sellrex>;
         using cnclrexorder_action = actc::action_wrapper<"cnclrexorder"_n, &system_contract::cnclrexorder>;
         using rentcpu_action = actc::action_wrapper<"rentcpu"_n, &system_contract::rentcpu>;
         using rentnet_action = actc::action_wrapper<"rentnet"_n, &system_contract::rentnet>;
         using fundcpuloan_action = actc::action_wrapper<"fundcpuloan"_n, &system_contract::fundcpuloan>;
         using fundnetloan_action = actc::action_wrapper<"fundnetloan"_n, &system_contract::fundnetloan>;
         using defcpuloan_action = actc::action_wrapper<"defcpuloan"_n, &system_contract::defcpuloan>;
         using defnetloan_action = actc::action_wrapper<"defnetloan"_n, &system_contract::defnetloan>;
         using updaterex_action = actc::action_wrapper<"updaterex"_n, &system_contract::updaterex>;
         using rexexec_action = actc::action_wrapper<"rexexec"_n, &system_contract::rexexec>;
         using setrex_action = actc::action_wrapper<"setrex"_n, &system_contract::setrex>;
         using mvtosavings_action = actc::action_wrapper<"mvtosavings"_n, &system_contract::mvtosavings>;
         using mvfrsavings_action = actc::action_wrapper<"mvfrsavings"_n, &system_contract::mvfrsavings>;
         using consolidate_action = actc::action_wrapper<"consolidate"_n, &system_contract::consolidate>;
         using closerex_action = actc::action_wrapper<"closerex"_n, &system_contract::closerex>;
         using undelegatebw_action = actc::action_wrapper<"undelegatebw"_n, &system_contract::undelegatebw>;
         using buyram_action = actc::action_wrapper<"buyram"_n, &system_contract::buyram>;
         using buyrambytes_action = actc::action_wrapper<"buyrambytes"_n, &system_contract::buyrambytes>;
         using sellram_action = actc::action_wrapper<"sellram"_n, &system_contract::sellram>;
         using refund_action = actc::action_wrapper<"refund"_n, &system_contract::refund>;
         using regproducer_action = actc::action_wrapper<"regproducer"_n, &system_contract::regproducer>;
...
//         using voteproducer_action = actc::action_wrapper<"voteproducer"_n, &system_contract::voteproducer>;
         ...
         using updtrevision_action = actc::action_wrapper<"updtrevision"_n, &system_contract::updtrevision>;
         using bidname_action = actc::action_wrapper<"bidname"_n, &system_contract::bidname>;
         using bidrefund_action = actc::action_wrapper<"bidrefund"_n, &system_contract::bidrefund>;
         using setpriv_action = actc::action_wrapper<"setpriv"_n, &system_contract::setpriv>;
         using setalimits_action = actc::action_wrapper<"setalimits"_n, &system_contract::setalimits>;
         using setparams_action = actc::action_wrapper<"setparams"_n, &system_contract::setparams>;
         using setinflation_action = actc::action_wrapper<"setinflation"_n, &system_contract::setinflation>;
      ...
      private:
         ...
         //defined in actc.system.cpp
         static actc_global_state get_default_parameters();
         static actc_global_state4 get_default_inflation_parameters();
