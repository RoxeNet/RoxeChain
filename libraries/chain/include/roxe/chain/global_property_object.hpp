...
#include <roxe/chain/incremental_merkle.hpp>
...
CHAINBASE_SET_INDEX_TYPE(roxe::chain::global_property_object, roxe::chain::global_property_multi_index)
CHAINBASE_SET_INDEX_TYPE(roxe::chain::dynamic_global_property_object,
                         roxe::chain::dynamic_global_property_multi_index)

FC_REFLECT(roxe::chain::global_property_object,
            (proposed_schedule_block_num)(proposed_schedule)(configuration)
          )

FC_REFLECT(roxe::chain::dynamic_global_property_object,
