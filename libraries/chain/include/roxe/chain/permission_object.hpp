...
CHAINBASE_SET_INDEX_TYPE(roxe::chain::permission_object, roxe::chain::permission_index)
CHAINBASE_SET_INDEX_TYPE(roxe::chain::permission_usage_object, roxe::chain::permission_usage_index)

FC_REFLECT(roxe::chain::permission_object, (usage_id)(parent)(owner)(name)(last_updated)(auth))
FC_REFLECT(roxe::chain::snapshot_permission_object, (parent)(owner)(name)(last_updated)(last_used)(auth))

FC_REFLECT(roxe::chain::permission_usage_object, (last_used))
