...
FC_REFLECT( roxe::chain::detail::block_header_state_common,
            (block_num)
...
FC_REFLECT( roxe::chain::detail::schedule_info,
            (schedule_lib_num)
            (schedule_hash)
            (schedule)
)

FC_REFLECT_DERIVED(  roxe::chain::block_header_state, (roxe::chain::detail::block_header_state_common),
                     (id)
                     (header)
                     (pending_schedule)
