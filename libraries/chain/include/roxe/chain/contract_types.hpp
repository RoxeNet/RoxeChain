...
using action_name    = roxe::chain::action_name;
...
FC_REFLECT( roxe::chain::newaccount                       , (creator)(name)(owner)(active) )
FC_REFLECT( roxe::chain::setcode                          , (account)(vmtype)(vmversion)(code) )
FC_REFLECT( roxe::chain::setabi                           , (account)(abi) )
FC_REFLECT( roxe::chain::updateauth                       , (account)(permission)(parent)(auth) )
FC_REFLECT( roxe::chain::deleteauth                       , (account)(permission) )
FC_REFLECT( roxe::chain::linkauth                         , (account)(code)(type)(requirement) )
FC_REFLECT( roxe::chain::unlinkauth                       , (account)(code)(type) )
FC_REFLECT( roxe::chain::canceldelay                      , (canceling_auth)(trx_id) )
FC_REFLECT( roxe::chain::onerror                          , (sender_id)(sent_trx) )
