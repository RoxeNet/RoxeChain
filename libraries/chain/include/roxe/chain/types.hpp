...
#include <roxe/chain/chain_id_type.hpp>
...
namespace roxe { namespace chain {
   ...
   /**
    *  Important notes on using chainbase objects in ROXE code:
    *
    ...
    *  others are due to requirements to ensure determinism in the ROXE chain library.
    *
