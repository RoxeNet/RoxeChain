...
#include <roxe/chain/multi_index_includes.hpp>
...
CHAINBASE_SET_INDEX_TYPE(roxe::chain::table_id_object, roxe::chain::table_id_multi_index)
CHAINBASE_SET_INDEX_TYPE(roxe::chain::key_value_object, roxe::chain::key_value_index)

CHAINBASE_SET_INDEX_TYPE(roxe::chain::index64_object, roxe::chain::index64_index)
CHAINBASE_SET_INDEX_TYPE(roxe::chain::index128_object, roxe::chain::index128_index)
CHAINBASE_SET_INDEX_TYPE(roxe::chain::index256_object, roxe::chain::index256_index)
CHAINBASE_SET_INDEX_TYPE(roxe::chain::index_double_object, roxe::chain::index_double_index)
CHAINBASE_SET_INDEX_TYPE(roxe::chain::index_long_double_object, roxe::chain::index_long_double_index)

FC_REFLECT(roxe::chain::table_id_object, (code)(scope)(table)(payer)(count) )
FC_REFLECT(roxe::chain::key_value_object, (primary_key)(payer)(value) )

#define REFLECT_SECONDARY(type)\
  FC_REFLECT(type, (primary_key)(payer)(secondary_key) )

REFLECT_SECONDARY(roxe::chain::index64_object)
REFLECT_SECONDARY(roxe::chain::index128_object)
REFLECT_SECONDARY(roxe::chain::index256_object)
REFLECT_SECONDARY(roxe::chain::index_double_object)
REFLECT_SECONDARY(roxe::chain::index_long_double_object)
