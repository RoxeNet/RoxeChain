...
CHAINBASE_SET_INDEX_TYPE(roxe::chain::permission_link_object, roxe::chain::permission_link_index)

FC_REFLECT(roxe::chain::permission_link_object, (account)(code)(message_type)(required_permission))
