...
#define ROXE_THROW( exc_type, FORMAT, ... ) \
    throw exc_type( FC_LOG_MESSAGE( error, FORMAT, __VA_ARGS__ ) );

/**
 * Macro inspired from FC_RETHROW_EXCEPTIONS
 * The main difference here is that if the exception caught isn't of type "roxe::chain::chain_exception"
 * This macro will rethrow the exception as the specified "exception_type"
 */
#define ROXE_RETHROW_EXCEPTIONS(exception_type, FORMAT, ... ) \
   catch (roxe::chain::chain_exception& e) { \
 ...
 * This macro will rethrow the exception as the specified "exception_type"
 */
#define ROXE_CAPTURE_AND_RETHROW( exception_type, ... ) \
   catch (roxe::chain::chain_exception& e) { \
...
#define ROXE_RECODE_EXC( cause_type, effect_type ) \
...
namespace roxe { namespace chain {
   ...
   FC_DECLARE_DERIVED_EXCEPTION( action_validate_exception, chain_exception,
      ...
      FC_DECLARE_DERIVED_EXCEPTION( roxe_assert_message_exception, action_validate_exception,
                                    3050003, "roxe_assert_message assertion failure" )
      FC_DECLARE_DERIVED_EXCEPTION( roxe_assert_code_exception, action_validate_exception,
                                    3050004, "roxe_assert_code assertion failure" )
      ...
      FC_DECLARE_DERIVED_EXCEPTION( restricted_error_code_exception, action_validate_exception,
                                    3050011, "roxe_assert_code assertion failure uses restricted error code value" )
