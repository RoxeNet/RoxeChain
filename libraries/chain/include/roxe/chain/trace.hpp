...
FC_REFLECT( roxe::chain::account_delta,
            (account)(delta) )

FC_REFLECT( roxe::chain::action_trace,
...
FC_REFLECT( roxe::chain::transaction_trace, (id)(block_num)(block_time)(producer_block_id)
