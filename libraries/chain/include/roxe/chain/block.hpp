...
FC_REFLECT_ENUM( roxe::chain::transaction_receipt::status_enum,
                 (executed)(soft_fail)(hard_fail)(delayed)(expired) )

FC_REFLECT(roxe::chain::transaction_receipt_header, (status)(cpu_usage_us)(net_usage_words) )
FC_REFLECT_DERIVED(roxe::chain::transaction_receipt, (roxe::chain::transaction_receipt_header), (trx) )
FC_REFLECT_DERIVED(roxe::chain::signed_block, (roxe::chain::signed_block_header), (transactions)(block_extensions) )
