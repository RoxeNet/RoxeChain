...
CHAINBASE_SET_INDEX_TYPE(roxe::chain::code_object, roxe::chain::code_index)

FC_REFLECT(roxe::chain::code_object, (code_hash)(code)(code_ref_count)(first_block_used)(vm_type)(vm_version))
