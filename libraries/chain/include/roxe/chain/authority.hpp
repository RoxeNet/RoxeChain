...
FC_REFLECT(roxe::chain::permission_level_weight, (permission)(weight) )
FC_REFLECT(roxe::chain::key_weight, (key)(weight) )
FC_REFLECT(roxe::chain::wait_weight, (wait_sec)(weight) )
FC_REFLECT(roxe::chain::authority, (threshold)(keys)(accounts)(waits) )
FC_REFLECT(roxe::chain::shared_authority, (threshold)(keys)(accounts)(waits) )
