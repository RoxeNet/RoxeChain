...
CHAINBASE_SET_INDEX_TYPE(dccio::chain::permission_object, dccio::chain::permission_index)
CHAINBASE_SET_INDEX_TYPE(dccio::chain::permission_usage_object, dccio::chain::permission_usage_index)

FC_REFLECT(dccio::chain::permission_object, (usage_id)(parent)(owner)(name)(last_updated)(auth))
FC_REFLECT(dccio::chain::snapshot_permission_object, (parent)(owner)(name)(last_updated)(last_used)(auth))

FC_REFLECT(dccio::chain::permission_usage_object, (last_used))
