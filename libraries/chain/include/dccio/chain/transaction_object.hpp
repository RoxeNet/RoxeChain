...
CHAINBASE_SET_INDEX_TYPE(dccio::chain::transaction_object, dccio::chain::transaction_multi_index)

FC_REFLECT(dccio::chain::transaction_object, (expiration)(trx_id))
