...
CHAINBASE_SET_INDEX_TYPE(dccio::chain::permission_link_object, dccio::chain::permission_link_index)

FC_REFLECT(dccio::chain::permission_link_object, (account)(code)(message_type)(required_permission))
