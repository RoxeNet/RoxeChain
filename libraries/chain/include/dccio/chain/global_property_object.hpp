...
#include <dccio/chain/incremental_merkle.hpp>
...
CHAINBASE_SET_INDEX_TYPE(dccio::chain::global_property_object, dccio::chain::global_property_multi_index)
CHAINBASE_SET_INDEX_TYPE(dccio::chain::dynamic_global_property_object,
                         dccio::chain::dynamic_global_property_multi_index)

FC_REFLECT(dccio::chain::dynamic_global_property_object,
           (global_action_sequence)
          )

FC_REFLECT(dccio::chain::global_property_object,
