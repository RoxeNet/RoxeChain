...
FC_REFLECT(dccio::chain::permission_level_weight, (permission)(weight) )
FC_REFLECT(dccio::chain::key_weight, (key)(weight) )
FC_REFLECT(dccio::chain::wait_weight, (wait_sec)(weight) )
FC_REFLECT(dccio::chain::authority, (threshold)(keys)(accounts)(waits) )
FC_REFLECT(dccio::chain::shared_authority, (threshold)(keys)(accounts)(waits) )
