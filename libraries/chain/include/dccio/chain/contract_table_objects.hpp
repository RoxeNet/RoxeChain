...
#include <dccio/chain/multi_index_includes.hpp>
...
CHAINBASE_SET_INDEX_TYPE(dccio::chain::table_id_object, dccio::chain::table_id_multi_index)
CHAINBASE_SET_INDEX_TYPE(dccio::chain::key_value_object, dccio::chain::key_value_index)

CHAINBASE_SET_INDEX_TYPE(dccio::chain::index64_object, dccio::chain::index64_index)
CHAINBASE_SET_INDEX_TYPE(dccio::chain::index128_object, dccio::chain::index128_index)
CHAINBASE_SET_INDEX_TYPE(dccio::chain::index256_object, dccio::chain::index256_index)
CHAINBASE_SET_INDEX_TYPE(dccio::chain::index_double_object, dccio::chain::index_double_index)
CHAINBASE_SET_INDEX_TYPE(dccio::chain::index_long_double_object, dccio::chain::index_long_double_index)

FC_REFLECT(dccio::chain::table_id_object, (code)(scope)(table)(payer)(count) )
FC_REFLECT(dccio::chain::key_value_object, (primary_key)(payer)(value) )

#define REFLECT_SECONDARY(type)\
  FC_REFLECT(type, (primary_key)(payer)(secondary_key) )

REFLECT_SECONDARY(dccio::chain::index64_object)
REFLECT_SECONDARY(dccio::chain::index128_object)
REFLECT_SECONDARY(dccio::chain::index256_object)
REFLECT_SECONDARY(dccio::chain::index_double_object)
REFLECT_SECONDARY(dccio::chain::index_long_double_object)
