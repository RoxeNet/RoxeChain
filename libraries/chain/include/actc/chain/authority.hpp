...
FC_REFLECT(actc::chain::permission_level_weight, (permission)(weight) )
FC_REFLECT(actc::chain::key_weight, (key)(weight) )
FC_REFLECT(actc::chain::wait_weight, (wait_sec)(weight) )
FC_REFLECT(actc::chain::authority, (threshold)(keys)(accounts)(waits) )
FC_REFLECT(actc::chain::shared_authority, (threshold)(keys)(accounts)(waits) )
