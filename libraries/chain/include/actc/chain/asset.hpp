...
namespace fc {
inline void to_variant(const actc::chain::asset& var, fc::variant& vo) { vo = var.to_string(); }
inline void from_variant(const fc::variant& var, actc::chain::asset& vo) {
   vo = actc::chain::asset::from_string(var.get_string());
}
}

FC_REFLECT(actc::chain::asset, (amount)(sym))
FC_REFLECT(actc::chain::extended_asset, (quantity)(contract) )
