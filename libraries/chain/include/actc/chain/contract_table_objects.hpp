...
#include <actc/chain/multi_index_includes.hpp>
...
CHAINBASE_SET_INDEX_TYPE(actc::chain::table_id_object, actc::chain::table_id_multi_index)
CHAINBASE_SET_INDEX_TYPE(actc::chain::key_value_object, actc::chain::key_value_index)

CHAINBASE_SET_INDEX_TYPE(actc::chain::index64_object, actc::chain::index64_index)
CHAINBASE_SET_INDEX_TYPE(actc::chain::index128_object, actc::chain::index128_index)
CHAINBASE_SET_INDEX_TYPE(actc::chain::index256_object, actc::chain::index256_index)
CHAINBASE_SET_INDEX_TYPE(actc::chain::index_double_object, actc::chain::index_double_index)
CHAINBASE_SET_INDEX_TYPE(actc::chain::index_long_double_object, actc::chain::index_long_double_index)

FC_REFLECT(actc::chain::table_id_object, (code)(scope)(table)(payer)(count) )
FC_REFLECT(actc::chain::key_value_object, (primary_key)(payer)(value) )

#define REFLECT_SECONDARY(type)\
  FC_REFLECT(type, (primary_key)(payer)(secondary_key) )

REFLECT_SECONDARY(actc::chain::index64_object)
REFLECT_SECONDARY(actc::chain::index128_object)
REFLECT_SECONDARY(actc::chain::index256_object)
REFLECT_SECONDARY(actc::chain::index_double_object)
REFLECT_SECONDARY(actc::chain::index_long_double_object)
