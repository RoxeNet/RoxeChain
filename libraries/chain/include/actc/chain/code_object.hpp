...
CHAINBASE_SET_INDEX_TYPE(actc::chain::code_object, actc::chain::code_index)

FC_REFLECT(actc::chain::code_object, (code_hash)(code)(code_ref_count)(first_block_used)(vm_type)(vm_version))
