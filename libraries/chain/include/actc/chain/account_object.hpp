...
CHAINBASE_SET_INDEX_TYPE(actc::chain::account_sequence_object, actc::chain::account_sequence_index)


FC_REFLECT(actc::chain::account_object, (name)(vm_type)(vm_version)(privileged)(last_code_update)(code_version)(creation_date)(code)(abi))
FC_REFLECT(actc::chain::account_sequence_object, (name)(recv_sequence)(auth_sequence)(code_sequence)(abi_sequence))