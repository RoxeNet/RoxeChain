...
namespace actc { namespace chain {
   ...
   class account_object : public chainbase::object<account_object_type, account_object> {
      ...
      void set_abi( const actc::chain::abi_def& a ) {
         abi.resize( fc::raw::pack_size( a ) );
         fc::datastream<char*> ds( abi.data(), abi.size() );
         fc::raw::pack( ds, a );
      }

      actc::chain::abi_def get_abi()const {
         actc::chain::abi_def a;
         ACTC_ASSERT( abi.size() != 0, abi_not_found_exception, "No ABI set on account ${n}", ("n",name) );
...
CHAINBASE_SET_INDEX_TYPE(actc::chain::account_object, actc::chain::account_index)
CHAINBASE_SET_INDEX_TYPE(actc::chain::account_metadata_object, actc::chain::account_metadata_index)
CHAINBASE_SET_INDEX_TYPE(actc::chain::account_ram_correction_object, actc::chain::account_ram_correction_index)


FC_REFLECT(actc::chain::account_object, (name)(creation_date)(abi))
FC_REFLECT(actc::chain::account_metadata_object, (name)(recv_sequence)(auth_sequence)(code_sequence)(abi_sequence)
                                                  (code_hash)(last_code_update)(flags)(vm_type)(vm_version))
FC_REFLECT(actc::chain::account_ram_correction_object, (name)(ram_correction))
