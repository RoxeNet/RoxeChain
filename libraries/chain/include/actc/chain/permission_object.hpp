...
CHAINBASE_SET_INDEX_TYPE(actc::chain::permission_object, actc::chain::permission_index)
CHAINBASE_SET_INDEX_TYPE(actc::chain::permission_usage_object, actc::chain::permission_usage_index)

FC_REFLECT(actc::chain::permission_object, (usage_id)(parent)(owner)(name)(last_updated)(auth))
FC_REFLECT(actc::chain::snapshot_permission_object, (parent)(owner)(name)(last_updated)(last_used)(auth))

FC_REFLECT(actc::chain::permission_usage_object, (last_used))
