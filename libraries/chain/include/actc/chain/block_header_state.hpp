...
FC_REFLECT( actc::chain::detail::block_header_state_common,
            (block_num)
...
FC_REFLECT( actc::chain::detail::schedule_info,
            (schedule_lib_num)
            (schedule_hash)
            (schedule)
)

FC_REFLECT_DERIVED(  actc::chain::block_header_state, (actc::chain::detail::block_header_state_common),
                     (id)
                     (header)
                     (pending_schedule)
