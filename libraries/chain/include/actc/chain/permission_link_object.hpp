...
CHAINBASE_SET_INDEX_TYPE(actc::chain::permission_link_object, actc::chain::permission_link_index)

FC_REFLECT(actc::chain::permission_link_object, (account)(code)(message_type)(required_permission))
