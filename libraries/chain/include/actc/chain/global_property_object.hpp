...
#include <actc/chain/incremental_merkle.hpp>
...
CHAINBASE_SET_INDEX_TYPE(actc::chain::global_property_object, actc::chain::global_property_multi_index)
CHAINBASE_SET_INDEX_TYPE(actc::chain::dynamic_global_property_object,
                         actc::chain::dynamic_global_property_multi_index)

FC_REFLECT(actc::chain::dynamic_global_property_object,
           (global_action_sequence)
          )

FC_REFLECT(actc::chain::global_property_object,
