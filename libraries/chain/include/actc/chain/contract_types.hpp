...
using action_name    = actc::chain::action_name;
...
FC_REFLECT( actc::chain::newaccount                       , (creator)(name)(owner)(active) )
FC_REFLECT( actc::chain::setcode                          , (account)(vmtype)(vmversion)(code) )
FC_REFLECT( actc::chain::setabi                           , (account)(abi) )
FC_REFLECT( actc::chain::updateauth                       , (account)(permission)(parent)(auth) )
FC_REFLECT( actc::chain::deleteauth                       , (account)(permission) )
FC_REFLECT( actc::chain::linkauth                         , (account)(code)(type)(requirement) )
FC_REFLECT( actc::chain::unlinkauth                       , (account)(code)(type) )
FC_REFLECT( actc::chain::canceldelay                      , (canceling_auth)(trx_id) )
FC_REFLECT( actc::chain::onerror                          , (sender_id)(sent_trx) )
