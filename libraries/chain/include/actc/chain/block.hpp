...
FC_REFLECT_ENUM( actc::chain::transaction_receipt::status_enum,
                 (executed)(soft_fail)(hard_fail)(delayed)(expired) )

FC_REFLECT(actc::chain::transaction_receipt_header, (status)(cpu_usage_us)(net_usage_words) )
FC_REFLECT_DERIVED(actc::chain::transaction_receipt, (actc::chain::transaction_receipt_header), (trx) )
FC_REFLECT_DERIVED(actc::chain::signed_block, (actc::chain::signed_block_header), (transactions)(block_extensions) )
