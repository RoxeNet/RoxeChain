...
namespace actc { namespace chain {
    ...
    *  In the context of actc, every action is dispatched to the handler defined
...
FC_REFLECT( actc::chain::permission_level, (actor)(permission) )
FC_REFLECT( actc::chain::action, (account)(name)(authorization)(data) )
