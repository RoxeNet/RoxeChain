...
namespace actc { namespace chain {
   ...
   /**
    *  Important notes on using chainbase objects in ACTC code:
    *
    ...
    *  others are due to requirements to ensure determinism in the ACTC chain library.
    *
