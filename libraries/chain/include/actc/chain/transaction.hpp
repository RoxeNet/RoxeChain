...
namespace actc { namespace chain {
   ...
   struct transaction : public transaction_header {
      ...
      vector<actc::chain::transaction_extensions> validate_and_extract_extensions()const;
   };
...
FC_REFLECT(actc::chain::deferred_transaction_generation_context, (sender_trx_id)(sender_id)(sender) )
