...
FC_REFLECT( actc::chain::account_delta,
            (account)(delta) )

FC_REFLECT( actc::chain::base_action_trace,
                    (receipt)(act)(context_free)(elapsed)(console)(trx_id)
                    (block_num)(block_time)(producer_block_id)(account_ram_deltas)(except) )

FC_REFLECT_DERIVED( actc::chain::action_trace,
                    (actc::chain::base_action_trace), (inline_traces) )

FC_REFLECT( actc::chain::transaction_trace, (id)(block_num)(block_time)(producer_block_id)
