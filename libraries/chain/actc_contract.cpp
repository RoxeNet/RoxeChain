...
void validate_authority_precondition( const apply_context& context, const authority& auth ) {
   for(const auto& a : auth.accounts) {
      ...
      if( a.permission.permission == config::actc_code_name ) // virtual actc.code permission does not really exist but is allowed
         continue;
...
void apply_actc_setcode(apply_context& context) {
...
void apply_actc_unlinkauth(apply_context& context) {
//   context.require_write_lock( config::actc_auth_scope );
