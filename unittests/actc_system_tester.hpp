...
//   }
   ...
   abi_serializer initialize_multisig() {
      abi_serializer msig_abi_ser;
      {
         ...
         BOOST_REQUIRE_EQUAL( success(), buyram( "actc", "gls.msig", core_from_string("5000.0000") ) );
         produce_block();
         ...
         set_code( N(gls.msig), contracts::actc_msig_wasm() );
         set_abi( N(gls.msig), contracts::actc_msig_abi().data() );
