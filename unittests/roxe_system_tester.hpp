...
public:
   ...
   roxe_system_tester(Lambda setup) {
      ...
      create_currency( N(roxe.token), config::system_account_name, core_from_string("10000000000.0000") );
      issue(config::system_account_name,      core_from_string("1000000000.0000"));
      BOOST_REQUIRE_EQUAL( core_from_string("1000000000.0000"), get_balance( "roxe" ) );
      ...
      BOOST_REQUIRE_EQUAL( core_from_string("1000000000.0000"), get_balance("roxe")  + get_balance("roxe.ramfee") + get_balance("roxe.stake") + get_balance("roxe.ram") );
   }
...
//   }
   ...
   asset get_balance( const account_name& act ) {
      vector<char> data = get_row_by_account( N(roxe.token), act, N(accounts), symbol(CORE_SYMBOL).to_symbol_code().value );
   ...
   abi_serializer initialize_multisig() {
      abi_serializer msig_abi_ser;
      {
         ...
         BOOST_REQUIRE_EQUAL( success(), buyram( "roxe", "roxe.msig", core_from_string("5000.0000") ) );
         produce_block();
         ...
         set_code( N(roxe.msig), contracts::roxe_msig_wasm() );
         set_abi( N(roxe.msig), contracts::roxe_msig_abi().data() );
   ...
   vector<name> active_and_vote_producers() {
      ...
      transfer( "roxe", "alice1111111", core_from_string("650000000.0000"), "roxe" );
...
inline uint64_t M( const string& roxe_str ) {
   return core_from_string( roxe_str ).get_amount();
}
