...
namespace actc { namespace cdt {
   struct abigen_exception : public std::exception {
      virtual const char* what() const throw() {
         return "actc.abigen fatal error";
      }
   };
   ...
   class abigen : public generation_utils {
      ...
      void add_action( const clang::CXXRecordDecl* decl ) {
         ...
         if (action_name.empty()) {
            try {
               ...
               std::cout << "Error, name <" <<decl->getName().str() << "> is an invalid ACTC name.\n";
               throw;
            }
            ...
            try {
               ...
               std::cout << "Error, name <" << action_name.str() << "> is an invalid ACTC name.\n";
               throw;
            }
      ...
      void add_action( const clang::CXXMethodDecl* decl ) {
         ...
         if (action_name.empty()) {
            try {
               ...
               std::cout << "Error, name <" <<decl->getNameAsString() << "> is an invalid ACTC name.\n";
            }
      ...
      std::string generate_json_comment() {
         std::stringstream ss;
         ss << "This file was generated with actc-abigen.";
         ss << " DO NOT EDIT ";
         return ss.str(); 
      }
