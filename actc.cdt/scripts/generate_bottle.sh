...
mkdir -p ${PROJECT}/${VERSION}/opt/actc_cdt/lib/cmake
...
echo "class ActcCdt < Formula
   ...
   homepage \"${URL}\"
   revision 0
   url \"https://github.com/actc/actc.cdt/archive/v${VERSION}.tar.gz\"
   version \"${VERSION}\"
   ...
   bottle do
      root_url \"https://github.com/actc/actc.cdt/releases/download/v${VERSION}\"
