...
namespace actc {
   ...
   inline DataStream& operator<<(DataStream& ds, const actc::public_key& pubkey) {
      ds << pubkey.type;
    ...
    */
   template<typename DataStream>
   inline DataStream& operator>>(DataStream& ds, actc::public_key& pubkey) {
      ds >> pubkey.type;
    ...
    */
   template<typename DataStream>
   inline DataStream& operator<<(DataStream& ds, const actc::signature& sig) {
      ds << sig.type;
    ...
    */
   template<typename DataStream>
   inline DataStream& operator>>(DataStream& ds, actc::signature& sig) {
      ds >> sig.type;
    ...
    *  @param data - Data you want to hash
    *  @param length - Data length
    *  @return actc::checksum256 - Computed digest
    */
    ...
    *  @param data - Data you want to hash
    *  @param length - Data length
    *  @return actc::checksum160 - Computed digest
    */
    ...
    *  @param data - Data you want to hash
    *  @param length - Data length
    *  @return actc::checksum512 - Computed digest
    */
    ...
    *  @param sig - Signature
    *  @return actc::public_key - Recovered public key
    */
