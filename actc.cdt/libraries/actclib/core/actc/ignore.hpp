...
namespace actc {
   ...
   inline DataStream& operator<<(DataStream& ds, const ::actc::ignore_wrapper<T>& val) {
     ds << val.value;
     return ds;
   }
    ...
    */
   template<typename DataStream, typename T>
   inline DataStream& operator<<(DataStream& ds, const ::actc::ignore<T>& val) {
     return ds;
   }
    ...
    */
   template<typename DataStream, typename T>
   inline DataStream& operator>>(DataStream& ds, ::actc::ignore<T>&) {
     return ds;
   }
}
