...
#include "../../contracts/actc/action.hpp"
#include "../../core/actc/name.hpp"
#include "../../core/actc/serialize.hpp"
#include "../../core/actc/fixed_bytes.hpp"
...
class multi_index
{
   ...
   public:
      ...
      const_iterator emplace( name payer, Lambda&& constructor ) {
         ...
         actc::check( _code == current_receiver(), "cannot create objects in table of another contract" ); // Quick fix for mutating db using multi_index that shouldn't allow mutation. Real fix can come in RC2.
      ...
      void modify( const T& obj, name payer, Lambda&& updater ) {
         ...
         actc::check( _code == current_receiver(), "cannot modify objects in table of another contract" ); // Quick fix for mutating db using multi_index that shouldn't allow mutation. Real fix can come in RC2.
      ...
      void erase( const T& obj ) {
         ...
         actc::check( _code == current_receiver(), "cannot erase objects in table of another contract" ); // Quick fix for mutating db using multi_index that shouldn't allow mutation. Real fix can come in RC2.
