...
#warning "<actclib/contract.hpp> is deprecated use <actc/contract.hpp>"

/**
 * @defgroup contract Contract
 * @ingroup types
 * @brief Defines contract type which is %base class for every ACTC contract
 * @{
 */
namespace actc {

/**
 * @brief %Base class for ACTC contract.
 * @details %Base class for ACTC contract. %A new contract should derive from this class, so it can make use of ACTC_ABI macro.
 */
class contract {
   public:
      /**
