...
namespace actc {
   ...
   private:
      ...
      public:
         ...
         {
            actc::check(_offset == _heap_size, "malloc_from_freed was designed to only be called after _heap was completely allocated");
