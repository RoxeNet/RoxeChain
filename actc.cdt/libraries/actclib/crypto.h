...
#warning "<actclib/crypto.h> is deprecated use <actc/crypto.h>. If you are using C++ the .h header files will be removed from inclusion entirely in v1.7.0"
 ...
 *  actc::print("sha256 hash generated from data equals provided hash");
 *  @endcode
 */
 ...
 *  actc::print("sha1 hash generated from data equals provided hash");
 *  @endcode
 */
__attribute__((actc_wasm_import))
 ...
 *  actc::print("sha512 hash generated from data equals provided hash");
 *  @endcode
 */
__attribute__((actc_wasm_import))
 ...
 *  actc::print("ripemod160 hash generated from data equals provided hash");
 *  @endcode
 */
__attribute__((actc_wasm_import))
 ...
 *  actc_assert( calc_hash == hash, "invalid hash" );
 *  @endcode
 */
__attribute__((actc_wasm_import))
 ...
 *  actc::print("pub key matches the pub key generated from digest");
 *  @endcode
 */
__attribute__((actc_wasm_import))
