...
#warning "<actclib/singleton.hpp> is deprecated use <actc/singleton.hpp>"
namespace  actc {

   /**
    *  @defgroup singleton Singleton Table
    *  @ingroup contracts
    *  @brief Defines ACTC Singleton Table used with %multiindex
    *  @{
    */
   ...
   class singleton
   {
      ...
      public:
         ...
         T get() {
            ...
            actc::check( itr != _t.end(), "singleton does not exist" );
            return itr->value;
         }
