...
#warning "<actclib/symbol.hpp> is deprecated use <actc/symbol.hpp>"
namespace actc {
   ...
   */
   ...
   public:
      ...
      */
      ...
      friend inline DataStream& operator<<(DataStream& ds, const actc::symbol_code sym_code) {
      ...
      */
      template<typename DataStream>
      friend inline DataStream& operator>>(DataStream& ds, actc::symbol_code& sym_code) {
         uint64_t raw = 0;
