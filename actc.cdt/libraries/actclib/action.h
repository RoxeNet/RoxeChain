...
#warning "<actclib/action.h> is deprecated use <actc/action.h>. If you are using C++ the .h header files will be removed from inclusion entirely in v1.7.0"
...
extern "C" {
    ...
    *
    *
    * A GLSchain action has the following abstract structure:
    *
    * ```
    *   struct action {
