...
#warning "<actclib/system.h> is deprecated use <actc/system.h>. If you are using C++ the .h header files will be removed from inclusion entirely in v1.7.0"
#ifdef __cplusplus
extern "C" {
#endif
    ...
    *
    *  @code
    *  actc_assert(1 == 2, "One is not equal to two.");
    *  actc_assert(1 == 1, "One is not equal to one.");
    *  @endcode
    *
