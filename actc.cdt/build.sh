...
if [[ "${unamestr}" == 'Darwin' ]]; then
   ...
   CXX_COMPILER=g++
   export ARCH="Darwin"
   bash ./scripts/actc_build_darwin.sh
else
   ...
   case "$OS_NAME" in
      "Amazon Linux AMI")
         ...
         bash ./scripts/actc_build_amazon.sh
         ;;
      "CentOS Linux")
         export ARCH="Centos"
         export CMAKE=${HOME}/opt/cmake/bin/cmake
         bash ./scripts/actc_build_centos.sh
         ;;
      "elementary OS")
         export ARCH="elementary OS"
         bash ./scripts/actc_build_ubuntu.sh
         ;;
      "Fedora")
         export ARCH="Fedora"
         bash ./scripts/actc_build_fedora.sh
         ;;
      "Linux Mint")
