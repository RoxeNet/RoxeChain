...
// Definitions in `actc.cdt/libraries/actc/time.hpp`
ACTC_TEST_BEGIN(microseconds_type_test)
...
// Definitions in `actc.cdt/libraries/actc/time.hpp`
ACTC_TEST_BEGIN(time_point_type_test)
...
// Definitions in `actc.cdt/libraries/actc/time.hpp`
ACTC_TEST_BEGIN(time_point_sec_type_test)
   static const microseconds ms0 { 0LL};
   static const microseconds ms1 { 1LL};
   static const microseconds msn1{-1LL};
   static const microseconds ms_min{i64min};
...
// Definitions in `actc.cdt/libraries/actc/time.hpp`
ACTC_TEST_BEGIN(block_timestamp_type_test)
...
int main(int argc, char* argv[]) {
   ...
   ACTC_TEST(microseconds_type_test);
   ACTC_TEST(time_point_type_test);
   ACTC_TEST(time_point_sec_type_test);
   ACTC_TEST(block_timestamp_type_test);
   return has_failed();
}
