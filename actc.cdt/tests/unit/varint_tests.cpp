...
// Defined in `actc.cdt/libraries/actc/varint.hpp`
ACTC_TEST_BEGIN(unsigned_int_type_test)
...
// Defined in `actc.cdt/libraries/actc/varint.hpp`
ACTC_TEST_BEGIN(signed_int_type_test)
   //// signed_int(uint32_t)
...
int main(int argc, char* argv[]) {
   ...
   ACTC_TEST(unsigned_int_type_test)
   ACTC_TEST(signed_int_type_test);
   return has_failed();
}
