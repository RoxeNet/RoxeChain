...
using actc::name;
using actc::symbol;
using actc::extended_symbol;
using actc::asset;
using actc::extended_asset;
...
// Definitions in `actc.cdt/libraries/actc/asset.hpp`
ACTC_TEST_BEGIN(asset_type_test)
...
// Definitions in `actc.cdt/libraries/actc/asset.hpp`
ACTC_TEST_BEGIN(extended_asset_type_test)
   static constexpr symbol sym_no_prec{"SYMBOLL",0};
   static constexpr symbol sym_prec{"SYMBOLL",63};

   static constexpr extended_symbol ext_sym_no_prec{sym_no_prec, name{"actcaccountj"}};
   static constexpr extended_symbol ext_sym_prec{sym_prec, name{"actcaccountj"}};
   ...
   CHECK_EQUAL( (extended_asset{{},ext_sym_no_prec}.contract), (name{"actcaccountj"}) )

   //// extended_asset(asset, name)
   CHECK_EQUAL( (extended_asset{asset_no_prec, name{"actcaccountj"}}.quantity), (asset{ 0LL, sym_no_prec}) )
   CHECK_EQUAL( (extended_asset{asset_no_prec, name{"actcaccountj"}}.contract), (name{"actcaccountj"}) )
   ...
   CHECK_ASSERT( "type mismatch", (
      [&]() {
         extended_asset{asset_no_prec, name{"actcaccountj"}} + extended_asset{asset_no_prec, name{"jtnuoccaoisoe"}};
      })
   )
   ...
   CHECK_ASSERT( "type mismatch", (
      [&]() {
         temp += extended_asset{asset_no_prec, name{"actcaccountj"}};
      })
   )
   ...
   // --------------------------------------------------------------------
   // friend bool operator!=(const extended_asset&, const extended_asset&)
   CHECK_EQUAL( (extended_asset{asset_no_prec, name{"actcaccountj"}} != extended_asset{asset_no_prec, name{"jtnuoccaoisoe"}}), true )
   CHECK_EQUAL( (extended_asset{asset{1LL, sym_no_prec}, {}} != extended_asset{asset{-1LL, sym_no_prec}, {}}), true )
   CHECK_EQUAL( (extended_asset{asset{1LL, sym_no_prec}, {}} != extended_asset{asset{ 0LL, sym_no_prec}, name{"actcaccountj"}}), true )
   ...
   CHECK_ASSERT( "type mismatch", (
      [&]() {
         bool b{extended_asset{{}, name{}} < extended_asset{{}, name{"actcaccountj"}}};
         return b;
      })
   )
...
int main(int argc, char* argv[]) {
   ...
   ACTC_TEST(asset_type_test);
   ACTC_TEST(extended_asset_type_test);
   return has_failed();
}
