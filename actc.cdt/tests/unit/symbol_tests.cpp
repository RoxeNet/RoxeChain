...
// Definitions in `actc.cdt/libraries/actc/symbol.hpp`
ACTC_TEST_BEGIN(symbol_code_type_test)
...
// Definitions in `actc.cdt/libraries/actc/symbol.hpp`
ACTC_TEST_BEGIN(symbol_type_test)
...
// Definitions in `actc.cdt/libraries/actc/symbol.hpp`
ACTC_TEST_BEGIN(extended_symbol_type_test)
...
int main(int argc, char* argv[]) {
   ...
   ACTC_TEST(symbol_code_type_test);
   ACTC_TEST(symbol_type_test);
   ACTC_TEST(extended_symbol_type_test);
   return has_failed();
}
