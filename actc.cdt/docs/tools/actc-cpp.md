### Usage
---
To manually compile the source code, use `actc-cpp/actc-cc` and `actc-ld` as if it were __clang__ and __lld__. All the includes and options specific to ACTC and CDT are baked in.

###$ actc-cpp
---
```
USAGE: actc-cpp [options] <input file> ...
