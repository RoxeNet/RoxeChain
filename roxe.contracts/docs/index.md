...
Below are listed the actions which are declared in the `roxe.bios` contract, mapped one-to-one with the native ROXE actions, but having no implementation at the contract level:
