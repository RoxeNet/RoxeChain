...
using namespace roxe_system;

BOOST_AUTO_TEST_SUITE(roxe_system_tests)
...
BOOST_FIXTURE_TEST_CASE( buysell, roxe_system_tester ) try {

   BOOST_REQUIRE_EQUAL( core_sym::from_string("0.0000"), get_balance( "alice1111111" ) );

   transfer( "roxe", "alice1111111", core_sym::from_string("1000.0000"), "roxe" );
   BOOST_REQUIRE_EQUAL( success(), stake( "roxe", "alice1111111", core_sym::from_string("200.0000"), core_sym::from_string("100.0000") ) );

   auto total = get_total_stake( "alice1111111" );
   auto init_bytes =  total["ram_bytes"].as_uint64();

   const asset initial_ram_balance = get_balance(N(roxe.ram));
   const asset initial_ramfee_balance = get_balance(N(roxe.ramfee));
   ...
   BOOST_REQUIRE_EQUAL( initial_ram_balance + core_sym::from_string("199.0000"), get_balance(N(roxe.ram)) );
   BOOST_REQUIRE_EQUAL( initial_ramfee_balance + core_sym::from_string("1.0000"), get_balance(N(roxe.ramfee)) );
   ...
   transfer( "roxe", "alice1111111", core_sym::from_string("100000000.0000"), "roxe" );
...
BOOST_FIXTURE_TEST_CASE( stake_unstake, roxe_system_tester ) try {
   ...
   const auto init_roxe_stake_balance = get_balance( N(roxe.stake) );
   ...
   BOOST_REQUIRE_EQUAL( init_roxe_stake_balance + core_sym::from_string("300.0000"), get_balance( N(roxe.stake) ) );
   ...
   produce_blocks(1);
   BOOST_REQUIRE_EQUAL( core_sym::from_string("1000.0000"), get_balance( "alice1111111" ) );
   BOOST_REQUIRE_EQUAL( init_roxe_stake_balance, get_balance( N(roxe.stake) ) );
...
BOOST_FIXTURE_TEST_CASE( stake_unstake_with_transfer, roxe_system_tester ) try {
   cross_15_percent_threshold();

   BOOST_REQUIRE_EQUAL( core_sym::from_string("0.0000"), get_balance( "alice1111111" ) );

   //roxe stakes for alice with transfer flag

   transfer( "roxe", "bob111111111", core_sym::from_string("1000.0000"), "roxe" );
   ...
   transfer( "roxe", "alice1111111", core_sym::from_string("1000.0000"), "roxe" );
   BOOST_REQUIRE_EQUAL( success(), stake( "alice1111111", "alice1111111", core_sym::from_string("200.0000"), core_sym::from_string("100.0000") ) );
   //now alice's stake should be equal to transfered from roxe + own stake
   total = get_total_stake("alice1111111");
   BOOST_REQUIRE_EQUAL( core_sym::from_string("700.0000"), get_balance( "alice1111111" ) );
...
BOOST_FIXTURE_TEST_CASE( stake_to_self_with_transfer, roxe_system_tester ) try {
   cross_15_percent_threshold();
...
BOOST_FIXTURE_TEST_CASE( stake_while_pending_refund, roxe_system_tester ) try {
   cross_15_percent_threshold();
...
BOOST_FIXTURE_TEST_CASE( fail_without_auth, roxe_system_tester ) try {
   cross_15_percent_threshold();

   issue_and_transfer( "alice1111111", core_sym::from_string("1000.0000"),  config::system_account_name );

   BOOST_REQUIRE_EQUAL( success(), stake( "roxe", "alice1111111", core_sym::from_string("2000.0000"), core_sym::from_string("1000.0000") ) );
...
BOOST_FIXTURE_TEST_CASE( stake_negative, roxe_system_tester ) try {
   issue_and_transfer( "alice1111111", core_sym::from_string("1000.0000"),  config::system_account_name );
...
BOOST_FIXTURE_TEST_CASE( unstake_negative, roxe_system_tester ) try {
   issue_and_transfer( "alice1111111", core_sym::from_string("1000.0000"),  config::system_account_name );
...
BOOST_FIXTURE_TEST_CASE( unstake_more_than_at_stake, roxe_system_tester ) try {
   cross_15_percent_threshold();
...
BOOST_FIXTURE_TEST_CASE( delegate_to_another_user, roxe_system_tester ) try {
   cross_15_percent_threshold();
...
BOOST_FIXTURE_TEST_CASE( stake_unstake_separate, roxe_system_tester ) try {
   cross_15_percent_threshold();
...
BOOST_FIXTURE_TEST_CASE( adding_stake_partial_unstake, roxe_system_tester ) try {
   cross_15_percent_threshold();
...
BOOST_FIXTURE_TEST_CASE( stake_from_refund, roxe_system_tester ) try {
   cross_15_percent_threshold();
...
BOOST_FIXTURE_TEST_CASE( stake_to_another_user_not_from_refund, roxe_system_tester ) try {
   cross_15_percent_threshold();
...
// Tests for voting
BOOST_FIXTURE_TEST_CASE( producer_register_unregister, roxe_system_tester ) try {
   issue_and_transfer( "alice1111111", core_sym::from_string("1000.0000"),  config::system_account_name );

   //fc::variant params = producer_parameters_example(1);
   auto key =  fc::crypto::public_key( std::string("ROXE6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV") );
   ...
   auto key2 =  fc::crypto::public_key( std::string("ROXE5jnmSKrzdBHE9n8hw58y7yxFWBC8SNiG7m8S1crJH3KvAnf9o6") );
   BOOST_REQUIRE_EQUAL( success(), push_action(N(alice1111111), N(regproducer), mvo()
                                               ("producer",  "alice1111111")
                                               ("producer_key", key2 )
                                               ("url", "http://block.two")
...
BOOST_FIXTURE_TEST_CASE( vote_for_producer, roxe_system_tester, * boost::unit_test::tolerance(1e+5) ) try {
   cross_15_percent_threshold();
...
//   BOOST_REQUIRE_EQUAL( success(), vote( N(carol1111111), { N(alice1111111) } ) );
   ...
   BOOST_REQUIRE_EQUAL( success(), unstake( "carol1111111", core_sym::from_string("2.0000"), core_sym::from_string("0.0002")/*"2.0000 ROXE", "0.0002 ROXE"*/ ) );
...
BOOST_FIXTURE_TEST_CASE( unregistered_producer_voting, roxe_system_tester, * boost::unit_test::tolerance(1e+5) ) try {
   issue_and_transfer( "bob111111111", core_sym::from_string("2000.0000"),  config::system_account_name );
...
BOOST_FIXTURE_TEST_CASE( more_than_30_producer_voting, roxe_system_tester ) try {
   issue_and_transfer( "bob111111111", core_sym::from_string("2000.0000"),  config::system_account_name );
   BOOST_REQUIRE_EQUAL( success(), stake( "bob111111111", core_sym::from_string("13.0000"), core_sym::from_string("0.5791") ) );
   REQUIRE_MATCHING_OBJECT( voter( "bob111111111", core_sym::from_string("13.5791") ), get_voter_info( "bob111111111" ) );
...
BOOST_FIXTURE_TEST_CASE( vote_same_producer_30_times, roxe_system_tester ) try {
   issue_and_transfer( "bob111111111", core_sym::from_string("2000.0000"),  config::system_account_name );
...
BOOST_FIXTURE_TEST_CASE( producer_keep_votes, roxe_system_tester, * boost::unit_test::tolerance(1e+5) ) try {
   issue_and_transfer( "alice1111111", core_sym::from_string("1000.0000"),  config::system_account_name );
   fc::variant params = producer_parameters_example(1);
...
BOOST_FIXTURE_TEST_CASE( vote_for_two_producers, roxe_system_tester, * boost::unit_test::tolerance(1e+5) ) try {
   //alice1111111 becomes a producer
   fc::variant params = producer_parameters_example(1);
...
BOOST_FIXTURE_TEST_CASE( proxy_register_unregister_keeps_stake, roxe_system_tester ) try {
...
BOOST_FIXTURE_TEST_CASE( proxy_stake_unstake_keeps_proxy_flag, roxe_system_tester ) try {
   cross_15_percent_threshold();
...
BOOST_FIXTURE_TEST_CASE( proxy_actions_affect_producers, roxe_system_tester, * boost::unit_test::tolerance(1e+5) ) try {
   cross_15_percent_threshold();
...
BOOST_FIXTURE_TEST_CASE(producer_pay, roxe_system_tester, * boost::unit_test::tolerance(1e-10)) try {
...
//   BOOST_REQUIRE_EQUAL(success(), vote( N(producvotera), { N(defproducera) }));
   ...
   // produce enough blocks so new schedule kicks in and defproducera produces some blocks
   {
      ...
      const int64_t  initial_savings           = get_balance(N(roxe.saving)).get_amount();
      ...
      const int64_t  savings           = get_balance(N(roxe.saving)).get_amount();
...
BOOST_FIXTURE_TEST_CASE(change_inflation, roxe_system_tester) try {
...
//      BOOST_REQUIRE_EQUAL(success(), vote( N(producvotera), { N(defproducera),N(defproducerb),N(defproducerc) }));
      ...
      auto run_for_1year = [this](int64_t annual_rate, int64_t inflation_pay_factor, int64_t votepay_factor) {
         ...
         const int64_t final_savings = get_balance(N(roxe.saving)).get_amount();
...
BOOST_AUTO_TEST_CASE(extreme_inflation) try {
   roxe_system_tester t(roxe_system_tester::setup_level::minimal);
   symbol core_symbol{CORE_SYM};
   t.create_currency( N(roxe.token), config::system_account_name, asset((1ll << 62) - 1, core_symbol) );
...
//   BOOST_REQUIRE_EQUAL(t.success(), t.vote( N(defproducera), { N(defproducera) }));
   ...
   {
      vector<char> data = t.get_row_by_account( N(roxe.token), core_symbol.to_symbol_code().value, N(stat), core_symbol.to_symbol_code().value );
      current_supply = t.token_abi_ser.binary_to_variant("currency_stats", data, roxe_system_tester::abi_serializer_max_time)["supply"].template as<asset>();
   }
...
BOOST_FIXTURE_TEST_CASE(multiple_producer_pay, roxe_system_tester, * boost::unit_test::tolerance(1e-10)) try {
...
//      BOOST_REQUIRE_EQUAL(success(), vote(N(producvoterd), vector<account_name>(producer_names.begin()+26, producer_names.end())));
...

   {
      ...
      const uint32_t initial_tot_unpaid_blocks = initial_global_state["total_unpaid_blocks"].as<uint32_t>();
      const asset    initial_supply            = get_token_supply();
      const asset    initial_bpay_balance      = get_balance(N(roxe.bpay));
      const asset    initial_vpay_balance      = get_balance(N(roxe.vpay));
      ...
      const uint32_t tot_unpaid_blocks = global_state["total_unpaid_blocks"].as<uint32_t>();
      const asset    supply            = get_token_supply();
      const asset    bpay_balance      = get_balance(N(roxe.bpay));
      const asset    vpay_balance      = get_balance(N(roxe.vpay));
...

   {
      ...
      BOOST_REQUIRE_EQUAL( error("missing authority of roxe"),
...
BOOST_FIXTURE_TEST_CASE(multiple_producer_votepay_share, roxe_system_tester, * boost::unit_test::tolerance(1e-10)) try {
...
BOOST_FIXTURE_TEST_CASE(votepay_share_invariant, roxe_system_tester, * boost::unit_test::tolerance(1e-10)) try {
...
BOOST_FIXTURE_TEST_CASE(votepay_share_proxy, roxe_system_tester, * boost::unit_test::tolerance(1e-5)) try {
...
BOOST_FIXTURE_TEST_CASE(votepay_share_update_order, roxe_system_tester, * boost::unit_test::tolerance(1e-10)) try {
...
BOOST_FIXTURE_TEST_CASE(votepay_transition, roxe_system_tester, * boost::unit_test::tolerance(1e-10)) try {
...
//   BOOST_REQUIRE_EQUAL( success(), vote(N(producvotera), vector<account_name>(producer_names.begin(), producer_names.end())) );
   auto* tbl = control->db().find<roxe::chain::table_id_object, roxe::chain::by_code_scope_table>(
   ...
   tbl = control->db().find<roxe::chain::table_id_object, roxe::chain::by_code_scope_table>(
                  boost::make_tuple( config::system_account_name,
                                     config::system_account_name,
                                     N(producers2) ) );
   BOOST_REQUIRE( !tbl );
...
BOOST_AUTO_TEST_CASE(votepay_transition2, * boost::unit_test::tolerance(1e-10)) try {
   ...
   std::string old_contract_core_symbol_name = "ROC"; // Set to core symbol used in contracts::util::system_wasm_old()
   symbol old_contract_core_symbol{::roxe::chain::string_to_symbol_c( 4, old_contract_core_symbol_name.c_str() )};

   auto old_core_from_string = [&]( const std::string& s ) {
      return roxe::chain::asset::from_string(s + " " + old_contract_core_symbol_name);
   };
   ...
   t.set_abi(  config::system_account_name, contracts::util::system_abi_old().data() );
   {
      ...
      t.abi_ser.set_abi(abi, roxe_system_tester::abi_serializer_max_time);
   }
...
//   BOOST_REQUIRE_EQUAL( t.success(), t.vote(N(producvoterc), vector<account_name>(producer_names.begin(), producer_names.end())) );
   ...
   auto* tbl = t.control->db().find<roxe::chain::table_id_object, roxe::chain::by_code_scope_table>(
                                    boost::make_tuple( config::system_account_name,
                                                       config::system_account_name,
                                                       N(producers2) ) );
   BOOST_REQUIRE( !tbl );
...
BOOST_FIXTURE_TEST_CASE(producers_upgrade_system_contract, roxe_system_tester) try {
...
BOOST_FIXTURE_TEST_CASE(producer_onblock_check, roxe_system_tester) try {
...
BOOST_FIXTURE_TEST_CASE( voters_actions_affect_proxy_and_producers, roxe_system_tester, * boost::unit_test::tolerance(1e+6) ) try {
   cross_15_percent_threshold();
...
BOOST_FIXTURE_TEST_CASE( vote_both_proxy_and_producers, roxe_system_tester ) try {
...
BOOST_FIXTURE_TEST_CASE( select_invalid_proxy, roxe_system_tester ) try {
   //accumulate proxied votes
   issue_and_transfer( "bob111111111", core_sym::from_string("1000.0000"),  config::system_account_name );
   BOOST_REQUIRE_EQUAL( success(), stake( "bob111111111", core_sym::from_string("100.0002"), core_sym::from_string("50.0001") ) );
...
BOOST_FIXTURE_TEST_CASE( double_register_unregister_proxy_keeps_votes, roxe_system_tester ) try {
   //alice1111111 becomes a proxy
   BOOST_REQUIRE_EQUAL( success(), push_action( N(alice1111111), N(regproxy), mvo()
                                                ("proxy",  "alice1111111")
                                                ("isproxy",  1)
...
BOOST_FIXTURE_TEST_CASE( proxy_cannot_use_another_proxy, roxe_system_tester ) try {
   //alice1111111 becomes a proxy
   BOOST_REQUIRE_EQUAL( success(), push_action( N(alice1111111), N(regproxy), mvo()
                                                ("proxy",  "alice1111111")
                                                ("isproxy",  1)
...
fc::mutable_variant_object config_to_variant( const roxe::chain::chain_config& config ) {
...
BOOST_FIXTURE_TEST_CASE( elect_producers /*_and_parameters*/, roxe_system_tester ) try {
   create_accounts_with_resources( {  N(defproducer1), N(defproducer2), N(defproducer3) } );
   BOOST_REQUIRE_EQUAL( success(), regproducer( "defproducer1", 1) );
   BOOST_REQUIRE_EQUAL( success(), regproducer( "defproducer2", 2) );
   BOOST_REQUIRE_EQUAL( success(), regproducer( "defproducer3", 3) );

   //stake more than 15% of total ROXE supply to activate chain
   transfer( "roxe", "alice1111111", core_sym::from_string("600000000.0000"), "roxe" );
...
BOOST_FIXTURE_TEST_CASE( buyname, roxe_system_tester ) try {
...
//   BOOST_REQUIRE_EQUAL( success(), vote( N(dan), { config::system_account_name } ) );
   ...
   BOOST_REQUIRE_EXCEPTION( create_accounts_with_resources( { N(fail) }, N(dan) ), // dan shouldn't be able to create fail
                            roxe_assert_message_exception, roxe_assert_message_is( "no active bid for name" ) );
   ...
   BOOST_REQUIRE_EXCEPTION( create_accounts_with_resources( { N(nofail) }, N(dan) ), // dan shoudn't be able to do this, sam won
                            roxe_assert_message_exception, roxe_assert_message_is( "only highest bidder can claim" ) );
   ...
   transfer( "roxe", "nofail", core_sym::from_string( "1000.0000" ) );
   ...
   BOOST_REQUIRE_EXCEPTION( create_accounts_with_resources( { N(test.fail) }, N(dan) ), // dan shouldn't be able to do this
                            roxe_assert_message_exception, roxe_assert_message_is( "only suffix may create this account" ) );

   create_accounts_with_resources( { N(goodgoodgood) }, N(dan) ); /// 12 char names should succeed
} FC_LOG_AND_RETHROW()

BOOST_FIXTURE_TEST_CASE( bid_invalid_names, roxe_system_tester ) try {
...
BOOST_FIXTURE_TEST_CASE( multiple_namebids, roxe_system_tester ) try {
...
//   BOOST_REQUIRE_EQUAL( success(), vote( N(carl), { N(producer) } ) );
   ...
   {
      const asset initial_names_balance = get_balance(N(roxe.names));
      BOOST_REQUIRE_EQUAL( success(),
      ...
      BOOST_REQUIRE_EQUAL( initial_names_balance + core_sym::from_string("0.1001"), get_balance(N(roxe.names)) );
   }
...
BOOST_FIXTURE_TEST_CASE( namebid_pending_winner, roxe_system_tester ) try {
   cross_15_percent_threshold();
...
BOOST_FIXTURE_TEST_CASE( vote_producers_in_and_out, roxe_system_tester ) try {
...
BOOST_FIXTURE_TEST_CASE( setparams, roxe_system_tester ) try {
   //install multisig contract
   abi_serializer msig_abi_ser = initialize_multisig();
   auto producer_names = active_and_vote_producers();
   ...
   roxe::chain::chain_config params;
...
BOOST_FIXTURE_TEST_CASE( setram_effect, roxe_system_tester ) try {
...
BOOST_FIXTURE_TEST_CASE( ram_inflation, roxe_system_tester ) try {
...
BOOST_FIXTURE_TEST_CASE( roxeram_ramusage, roxe_system_tester ) try {
   BOOST_REQUIRE_EQUAL( core_sym::from_string("0.0000"), get_balance( "alice1111111" ) );
   transfer( "roxe", "alice1111111", core_sym::from_string("1000.0000"), "roxe" );
   BOOST_REQUIRE_EQUAL( success(), stake( "roxe", "alice1111111", core_sym::from_string("200.0000"), core_sym::from_string("100.0000") ) );
   ...
   BOOST_REQUIRE_EQUAL( false, get_row_by_account( N(roxe.token), N(alice1111111), N(accounts), symbol{CORE_SYM}.to_symbol_code() ).empty() );

   //remove row
   base_tester::push_action( N(roxe.token), N(close), N(alice1111111), mvo()
                             ( "owner", "alice1111111" )
                             ( "symbol", symbol{CORE_SYM} )
   );
   BOOST_REQUIRE_EQUAL( true, get_row_by_account( N(roxe.token), N(alice1111111), N(accounts), symbol{CORE_SYM}.to_symbol_code() ).empty() );

   auto rlm = control->get_resource_limits_manager();
   auto roxeram_ram_usage = rlm.get_account_ram_usage(N(roxe.ram));
   auto alice_ram_usage = rlm.get_account_ram_usage(N(alice1111111));

   BOOST_REQUIRE_EQUAL( success(), sellram( "alice1111111", 2048 ) );

   //make sure that ram was billed to alice, not to roxe.ram
   BOOST_REQUIRE_EQUAL( true, alice_ram_usage < rlm.get_account_ram_usage(N(alice1111111)) );
   BOOST_REQUIRE_EQUAL( roxeram_ram_usage, rlm.get_account_ram_usage(N(roxe.ram)) );

} FC_LOG_AND_RETHROW()

BOOST_FIXTURE_TEST_CASE( ram_gift, roxe_system_tester ) try {
   ...
   */
   ...
   BOOST_REQUIRE_EQUAL( success(), unstake( "roxe", "alice1111111", core_sym::from_string("20.0000"), core_sym::from_string("10.0000") ) );
...
BOOST_FIXTURE_TEST_CASE( rex_auth, roxe_system_tester ) try {
   ...
   const asset one_roxe      = core_sym::from_string("1.0000");
   ...
   BOOST_REQUIRE_EQUAL( error(error_msg), push_action( bob, N(deposit), mvo()("owner", alice)("amount", one_roxe) ) );
   BOOST_REQUIRE_EQUAL( error(error_msg), push_action( bob, N(withdraw), mvo()("owner", alice)("amount", one_roxe) ) );
   BOOST_REQUIRE_EQUAL( error(error_msg), push_action( bob, N(buyrex), mvo()("from", alice)("amount", one_roxe) ) );
   BOOST_REQUIRE_EQUAL( error(error_msg),
                        push_action( bob, N(unstaketorex), mvo()("owner", alice)("receiver", alice)("from_net", one_roxe)("from_cpu", one_roxe) ) );
   ...
   BOOST_REQUIRE_EQUAL( error(error_msg),
                        push_action( bob, N(rentcpu), mvo()("from", alice)("receiver", alice)("loan_payment", one_roxe)("loan_fund", one_roxe) ) );
   BOOST_REQUIRE_EQUAL( error(error_msg),
                        push_action( bob, N(rentnet), mvo()("from", alice)("receiver", alice)("loan_payment", one_roxe)("loan_fund", one_roxe) ) );
   BOOST_REQUIRE_EQUAL( error(error_msg), push_action( bob, N(fundcpuloan), mvo()("from", alice)("loan_num", 1)("payment", one_roxe) ) );
   BOOST_REQUIRE_EQUAL( error(error_msg), push_action( bob, N(fundnetloan), mvo()("from", alice)("loan_num", 1)("payment", one_roxe) ) );
   BOOST_REQUIRE_EQUAL( error(error_msg), push_action( bob, N(defcpuloan), mvo()("from", alice)("loan_num", 1)("amount", one_roxe) ) );
   BOOST_REQUIRE_EQUAL( error(error_msg), push_action( bob, N(defnetloan), mvo()("from", alice)("loan_num", 1)("amount", one_roxe) ) );
   ...
   BOOST_REQUIRE_EQUAL( error("missing authority of roxe"), push_action( alice, N(setrex), mvo()("balance", one_roxe) ) );

} FC_LOG_AND_RETHROW()


BOOST_FIXTURE_TEST_CASE( buy_sell_rex, roxe_system_tester ) try {
...
BOOST_FIXTURE_TEST_CASE( buy_sell_small_rex, roxe_system_tester ) try {
...
BOOST_FIXTURE_TEST_CASE( unstake_buy_rex, roxe_system_tester, * boost::unit_test::tolerance(1e-10) ) try {
...
//                           vote( alice, std::vector<account_name>(producer_names.begin(), producer_names.begin() + 21) ) );
      const asset init_roxe_stake_balance = get_balance( N(roxe.stake) );
      ...
      BOOST_REQUIRE_EQUAL( tot_stake,                               get_balance( N(roxe.rex) ) );
      BOOST_REQUIRE_EQUAL( tot_stake,                               init_roxe_stake_balance - get_balance( N(roxe.stake) ) );
...
BOOST_FIXTURE_TEST_CASE( buy_rent_rex, roxe_system_tester ) try {
...
BOOST_FIXTURE_TEST_CASE( buy_sell_sell_rex, roxe_system_tester ) try {
...
BOOST_FIXTURE_TEST_CASE( buy_sell_claim_rex, roxe_system_tester ) try {
   ...
   const int64_t init_alice_rex_stake = ( roxe::chain::uint128_t(init_alice_rex.get_amount()) * total_lendable ) / total_rex;
...
BOOST_FIXTURE_TEST_CASE( rex_loans, roxe_system_tester ) try {
...
BOOST_FIXTURE_TEST_CASE( rex_loan_checks, roxe_system_tester ) try {
...
BOOST_FIXTURE_TEST_CASE( ramfee_namebid_to_rex, roxe_system_tester ) try {
   ...
   asset cur_ramfee_balance = get_balance( N(roxe.ramfee) );
   BOOST_REQUIRE_EQUAL( success(),                      buyram( alice, alice, core_sym::from_string("20.0000") ) );
   BOOST_REQUIRE_EQUAL( get_balance( N(roxe.ramfee) ), core_sym::from_string("0.1000") + cur_ramfee_balance );
   ...
   cur_ramfee_balance = get_balance( N(roxe.ramfee) );
   asset cur_rex_balance = get_balance( N(roxe.rex) );
   ...
   BOOST_REQUIRE_EQUAL( cur_ramfee_balance,                get_balance( N(roxe.ramfee) ) );
   BOOST_REQUIRE_EQUAL( get_balance( N(roxe.rex) ),       cur_rex_balance + core_sym::from_string("0.3500") );

   cur_rex_balance = get_balance( N(roxe.rex) );
   ...
   BOOST_REQUIRE_EQUAL( core_sym::from_string("23.7000"), get_balance( N(roxe.names) ) );
   BOOST_REQUIRE_EQUAL( success(),                        bidname( alice, N(rndmbid), core_sym::from_string("29.3500") ) );
   BOOST_REQUIRE_EQUAL( core_sym::from_string("29.3500"), get_balance( N(roxe.names) ));
   ...
   BOOST_REQUIRE_EQUAL( get_balance( N(roxe.rex) ),      cur_rex_balance + core_sym::from_string("34.3500") );
   BOOST_REQUIRE_EQUAL( 0,                                get_balance( N(roxe.names) ).get_amount() );
...
BOOST_FIXTURE_TEST_CASE( rex_maturity, roxe_system_tester ) try {
...
BOOST_FIXTURE_TEST_CASE( rex_savings, roxe_system_tester ) try {
...
BOOST_FIXTURE_TEST_CASE( update_rex, roxe_system_tester, * boost::unit_test::tolerance(1e-10) ) try {
...
//                        vote( alice, std::vector<account_name>(producer_names.begin(), producer_names.begin() + 21) ) );
   ...
   const int64_t init_alice_rex_stake = ( roxe::chain::uint128_t(init_rex.get_amount()) * total_lendable ) / total_rex;
...
BOOST_FIXTURE_TEST_CASE( update_rex_vote, roxe_system_tester, * boost::unit_test::tolerance(1e-8) ) try {
...
BOOST_FIXTURE_TEST_CASE( deposit_rex_fund, roxe_system_tester ) try {
...
BOOST_FIXTURE_TEST_CASE( rex_lower_bound, roxe_system_tester ) try {
   ...
   double rex_per_roxe = double(tot_rex) / double(tot_lendable);
   int64_t sell_amount = rex_per_roxe * ( tot_unlent - 0.09 * tot_lent );
   produce_block( fc::days(5) );
   BOOST_REQUIRE_EQUAL( success(), sellrex( alice, asset( sell_amount, rex_sym ) ) );
   BOOST_REQUIRE_EQUAL( success(), cancelrexorder( alice ) );
   sell_amount = rex_per_roxe * ( tot_unlent - 0.1 * tot_lent );
   BOOST_REQUIRE_EQUAL( success(), sellrex( alice, asset( sell_amount, rex_sym ) ) );
...
BOOST_FIXTURE_TEST_CASE( close_rex, roxe_system_tester ) try {
...
BOOST_FIXTURE_TEST_CASE( set_rex, roxe_system_tester ) try {
...
BOOST_FIXTURE_TEST_CASE( b1_vesting, roxe_system_tester ) try {
...
BOOST_FIXTURE_TEST_CASE( rex_return, roxe_system_tester ) try {
...
BOOST_AUTO_TEST_CASE( setabi_bios ) try {
   ...
   t.create_account(N(roxe.token));
   t.set_abi( N(roxe.token), contracts::token_abi().data() );
   {
      auto res = t.get_row_by_account( config::system_account_name, config::system_account_name, N(abihash), N(roxe.token) );
      _abi_hash abi_hash;
   ...
   t.set_abi( N(roxe.token), contracts::system_abi().data() );
   {
      auto res = t.get_row_by_account( config::system_account_name, config::system_account_name, N(abihash), N(roxe.token) );
      _abi_hash abi_hash;
      auto abi_hash_var = abi_ser.binary_to_variant( "abi_hash", res, base_tester::abi_serializer_max_time );
...
BOOST_FIXTURE_TEST_CASE( setabi, roxe_system_tester ) try {
   set_abi( N(roxe.token), contracts::token_abi().data() );
   {
      auto res = get_row_by_account( config::system_account_name, config::system_account_name, N(abihash), N(roxe.token) );
      _abi_hash abi_hash;
   ...
   set_abi( N(roxe.token), contracts::system_abi().data() );
   {
      auto res = get_row_by_account( config::system_account_name, config::system_account_name, N(abihash), N(roxe.token) );
      _abi_hash abi_hash;
      auto abi_hash_var = abi_ser.binary_to_variant( "abi_hash", res, abi_serializer_max_time );
...
BOOST_FIXTURE_TEST_CASE( change_limited_account_back_to_unlimited, roxe_system_tester ) try {
   BOOST_REQUIRE( get_total_stake( "roxe" ).is_null() );

   transfer( N(roxe), N(alice1111111), core_sym::from_string("1.0000") );

   auto error_msg = stake( N(alice1111111), N(roxe), core_sym::from_string("0.0000"), core_sym::from_string("1.0000") );
   auto semicolon_pos = error_msg.find(';');

   BOOST_REQUIRE_EQUAL( error("account roxe has insufficient ram"),
   ...
   push_action( N(roxe), N(setalimits), mvo()
                                          ("account", "roxe")
   ...
   stake( N(alice1111111), N(roxe), core_sym::from_string("0.0000"), core_sym::from_string("1.0000") );

   REQUIRE_MATCHING_OBJECT( get_total_stake( "roxe" ), mvo()
      ("owner", "roxe")
   ...
   BOOST_REQUIRE_EQUAL( success(),
                        push_action( N(roxe), N(setacctnet), mvo()
                           ("account", "roxe")
                           ("net_weight", -1)
                        )
   );
   ...
   BOOST_REQUIRE_EQUAL( success(),
                        push_action( N(roxe), N(setacctcpu), mvo()
                           ("account", "roxe")
                           ("cpu_weight", -1)
...
BOOST_FIXTURE_TEST_CASE( buy_pin_sell_ram, roxe_system_tester ) try {
   BOOST_REQUIRE( get_total_stake( "roxe" ).is_null() );

   transfer( N(roxe), N(alice1111111), core_sym::from_string("1020.0000") );

   auto error_msg = stake( N(alice1111111), N(roxe), core_sym::from_string("10.0000"), core_sym::from_string("10.0000") );
   auto semicolon_pos = error_msg.find(';');
   ...
   BOOST_REQUIRE_EQUAL( success(), buyrambytes( N(alice1111111), N(roxe), static_cast<uint32_t>(ram_bytes_needed) ) );

   auto tokens_paid_for_ram = alice_original_balance - get_balance( N(alice1111111) );

   auto total_res = get_total_stake( "roxe" );
   ...
   BOOST_REQUIRE_EQUAL( success(),
                        push_action( N(roxe), N(setacctram), mvo()
                           ("account", "roxe")
                           ("ram_bytes", total_res["ram_bytes"].as_int64() )
                        )
   );

   auto roxe_original_balance = get_balance( N(roxe) );

   BOOST_REQUIRE_EQUAL( success(), sellram( N(roxe), total_res["ram_bytes"].as_int64() ) );

   auto tokens_received_by_selling_ram = get_balance( N(roxe) ) - roxe_original_balance;
