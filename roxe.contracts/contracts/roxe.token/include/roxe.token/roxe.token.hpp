...
namespace roxe {
   ...
   class [[roxe::contract("roxe.token")]] token : public contract {
      public:
         ...
         /**
<<<<<<< HEAD:roxe.contracts/contracts/roxe.token/include/roxe.token/roxe.token.hpp
...
>>>>>>> v1.0.1:roxe.contracts/contracts/roxe.token/include/roxe.token/roxe.token.hpp
