...
#include <roxe/binary_extension.hpp>
...
namespace roxe {
   ...
   /**
    * @defgroup roxemsig roxe.msig
    * @ingroup roxecontracts
    * roxe.msig contract defines the structures and actions needed to manage the proposals and approvals on blockchain.
    * @{
    */
   class [[roxe::contract("roxe.msig")]] multisig : public contract {
      public:
         ...
         void approve( name proposer, name proposal_name, permission_level level,
                       const roxe::binary_extension<roxe::checksum256>& proposal_hash );
         /**
          * Revoke proposal
          *
         ...
         using propose_action = roxe::action_wrapper<"propose"_n, &multisig::propose>;
         using approve_action = roxe::action_wrapper<"approve"_n, &multisig::approve>;
         using unapprove_action = roxe::action_wrapper<"unapprove"_n, &multisig::unapprove>;
         using cancel_action = roxe::action_wrapper<"cancel"_n, &multisig::cancel>;
         using exec_action = roxe::action_wrapper<"exec"_n, &multisig::exec>;
         using invalidate_action = roxe::action_wrapper<"invalidate"_n, &multisig::invalidate>;

      private:
         struct [[roxe::table]] proposal {
            name                            proposal_name;
         ...
         typedef roxe::multi_index< "proposal"_n, proposal > proposals;

         struct [[roxe::table]] old_approvals_info {
            name                            proposal_name;
         ...
         typedef roxe::multi_index< "approvals"_n, old_approvals_info > old_approvals;
         ...
         struct [[roxe::table]] approvals_info {
            uint8_t                 version = 1;
            name                    proposal_name;
         ...
         typedef roxe::multi_index< "approvals2"_n, approvals_info > approvals;

         struct [[roxe::table]] invalidation {
            name         account;
         ...
         typedef roxe::multi_index< "invals"_n, invalidation > invalidations;
   };
   /** @}*/ // end of @defgroup roxemsig roxe.msig
} /// namespace roxe
