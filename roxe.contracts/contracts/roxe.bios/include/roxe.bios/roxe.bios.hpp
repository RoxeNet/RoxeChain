 ...
 * ROXE Contracts
 *
 * @details The design of the ROXE blockchain calls for a number of smart contracts that are run at a
 ...
 * managing, and/or using an ROXE blockchain. They are provided for reference purposes:
 * - roxe.bios
 * - roxe.system
 * - roxe.msig
 * - roxe.wrap
...
namespace roxe {
   ...
   class [[roxe::contract("roxe.bios")]] bios : public contract {
      public:
          ...
          */
         [[roxe::action]]
         void setprods( std::vector<roxe::producer_key> schedule );
          ...
          */
         [[roxe::action]]
         void reqactivated( const roxe::checksum256& feature_digest );

         struct [[roxe::table]] abi_hash {
            name              owner;
            checksum256       hash;
         ...
         typedef roxe::multi_index< "abihash"_n, abi_hash > abi_hash_table;
