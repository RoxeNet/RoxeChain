...
#include <roxe/time.hpp>

#include <roxe.system/exchange_state.hpp>
...
namespace roxesystem {
   ...
   using roxe::asset;
   using roxe::block_timestamp;
   using roxe::check;
   using roxe::const_mem_fun;
   using roxe::datastream;
   using roxe::indexed_by;
   using roxe::name;
   using roxe::same_payer;
   using roxe::symbol;
   using roxe::symbol_code;
   using roxe::time_point;
   using roxe::time_point_sec;
   using roxe::unsigned_int;
   ...
   /**
    * roxe.system contract defines the structures and actions needed for blockchain's core functionality.
   ...
   struct [[roxe::table, roxe::contract("roxe.system")]] name_bid {
     name            newname;
     name            high_bidder;
   ...
   struct [[roxe::table, roxe::contract("roxe.system")]] bid_refund {
      name         bidder;
      asset        amount;

      uint64_t primary_key()const { return bidder.value; }
   };
   typedef roxe::multi_index< "namebids"_n, name_bid,
                               indexed_by<"highbid"_n, const_mem_fun<name_bid, uint64_t, &name_bid::by_high_bid>  >
                             > name_bid_table;

   typedef roxe::multi_index< "bidrefunds"_n, bid_refund > bid_refund_table;

   // Defines new global state parameters.
   struct [[roxe::table("global"), roxe::contract("roxe.system")]] roxe_global_state : roxe::blockchain_parameters {
      ...
      ROXELIB_SERIALIZE_DERIVED( roxe_global_state, roxe::blockchain_parameters,
   ...
   struct [[roxe::table("global2"), roxe::contract("roxe.system")]] roxe_global_state2 {
      roxe_global_state2(){}
      ...
      ROXELIB_SERIALIZE( roxe_global_state2, (new_ram_per_block)(last_ram_increase)(last_block_num)
                        (total_producer_votepay_share)(revision) )
   };

   // Defines new global state parameters added after version 1.3.0
   struct [[roxe::table("global3"), roxe::contract("roxe.system")]] roxe_global_state3 {
      roxe_global_state3() { }
      time_point        last_vpay_state_update;
      double            total_vpay_share_change_rate = 0;

      ROXELIB_SERIALIZE( roxe_global_state3, (last_vpay_state_update)(total_vpay_share_change_rate) )
   };

   // Defines new global state parameters to store inflation rate and distribution
   struct [[roxe::table("global4"), roxe::contract("roxe.system")]] roxe_global_state4 {
      roxe_global_state4() { }
      double   continuous_rate;
      int64_t  inflation_pay_factor;
      int64_t  votepay_factor;

      ROXELIB_SERIALIZE( roxe_global_state4, (continuous_rate)(inflation_pay_factor)(votepay_factor) )
   };

   // Defines `producer_info` structure to be stored in `producer_info` table, added after version 1.0
   struct [[roxe::table, roxe::contract("roxe.system")]] producer_info {
      name                  owner;
      double                total_votes = 0;
      roxe::public_key     producer_key; /// a packed public key object
      bool                  is_active = true;
      std::string           url;
      ...
      // explicit serialization macro is not necessary, used here only to improve compilation time
      ROXELIB_SERIALIZE( producer_info, (owner)(total_votes)(producer_key)(is_active)(url)
                        (unpaid_blocks)(last_claim_time)(location) )
   };

   // Defines new producer info structure to be stored in new producer info table, added after version 1.3.0
   struct [[roxe::table, roxe::contract("roxe.system")]] producer_info2 {
      name            owner;
      ...
      // explicit serialization macro is not necessary, used here only to improve compilation time
      ROXELIB_SERIALIZE( producer_info2, (owner)(votepay_share)(last_votepay_share_update) )
   };
   ...
   struct [[roxe::table, roxe::contract("roxe.system")]] voter_info {
      ...
      // explicit serialization macro is not necessary, used here only to improve compilation time
      ROXELIB_SERIALIZE( voter_info, (owner)(proxy)(producers)(staked)(last_vote_weight)(proxied_vote_weight)(is_proxy)(flags1)(reserved2)(reserved3) )
   };


   typedef roxe::multi_index< "voters"_n, voter_info >  voters_table;


   typedef roxe::multi_index< "producers"_n, producer_info,
                               indexed_by<"prototalvote"_n, const_mem_fun<producer_info, double, &producer_info::by_votes>  >
                             > producers_table;

   typedef roxe::multi_index< "producers2"_n, producer_info2 > producers_table2;


   typedef roxe::singleton< "global"_n, roxe_global_state >   global_state_singleton;

   typedef roxe::singleton< "global2"_n, roxe_global_state2 > global_state2_singleton;

   typedef roxe::singleton< "global3"_n, roxe_global_state3 > global_state3_singleton;

   typedef roxe::singleton< "global4"_n, roxe_global_state4 > global_state4_singleton;

   struct [[roxe::table, roxe::contract("roxe.system")]] user_resources {
      name          owner;
      asset         net_weight;
      asset         cpu_weight;
      int64_t       ram_bytes = 0;
      ...
      // explicit serialization macro is not necessary, used here only to improve compilation time
      ROXELIB_SERIALIZE( user_resources, (owner)(net_weight)(cpu_weight)(ram_bytes) )
   };

   // Every user 'from' has a scope/table that uses every receipient 'to' as the primary key.
   struct [[roxe::table, roxe::contract("roxe.system")]] delegated_bandwidth {
      name          from;
      name          to;
      asset         net_weight;
      asset         cpu_weight;
      ...
      // explicit serialization macro is not necessary, used here only to improve compilation time
      ROXELIB_SERIALIZE( delegated_bandwidth, (from)(to)(net_weight)(cpu_weight) )

   };

   struct [[roxe::table, roxe::contract("roxe.system")]] refund_request {
      name            owner;
      time_point_sec  request_time;
      roxe::asset    net_amount;
      roxe::asset    cpu_amount;

      bool is_empty()const { return net_amount.amount == 0 && cpu_amount.amount == 0; }
      uint64_t  primary_key()const { return owner.value; }

      // explicit serialization macro is not necessary, used here only to improve compilation time
      ROXELIB_SERIALIZE( refund_request, (owner)(request_time)(net_amount)(cpu_amount) )
   };


   typedef roxe::multi_index< "userres"_n, user_resources >      user_resources_table;
   typedef roxe::multi_index< "delband"_n, delegated_bandwidth > del_bandwidth_table;
   typedef roxe::multi_index< "refunds"_n, refund_request >      refunds_table;
   ...
   struct [[roxe::table,roxe::contract("roxe.system")]] rex_pool {
      uint8_t    version = 0;
      asset      total_lent;
      asset      total_unlent;
      asset      total_rent;
   ...
   typedef roxe::multi_index< "rexpool"_n, rex_pool > rex_pool_table;
   ...
   struct [[roxe::table,roxe::contract("roxe.system")]] rex_return_pool {
      uint8_t        version = 0;
   ...
   typedef roxe::multi_index< "rexretpool"_n, rex_return_pool > rex_return_pool_table;
   ...
   struct [[roxe::table,roxe::contract("roxe.system")]] rex_return_buckets {
      uint8_t                           version = 0;
   ...
   typedef roxe::multi_index< "retbuckets"_n, rex_return_buckets > rex_return_buckets_table;
   ...
   struct [[roxe::table,roxe::contract("roxe.system")]] rex_fund {
      uint8_t version = 0;
      name    owner;
      asset   balance;
   ...
   typedef roxe::multi_index< "rexfund"_n, rex_fund > rex_fund_table;
   ...
   struct [[roxe::table,roxe::contract("roxe.system")]] rex_balance {
      uint8_t version = 0;
      name    owner;
      asset   vote_stake;
      asset   rex_balance;
   ...
   typedef roxe::multi_index< "rexbal"_n, rex_balance > rex_balance_table;
   ...
   // - `payment` ROC tokens paid for the loan,
   // - `balance` is the amount of ROC tokens available to be used for loan auto-renewal,
   ...
   struct [[roxe::table,roxe::contract("roxe.system")]] rex_loan {
      uint8_t             version = 0;
      name                from;
      name                receiver;
      asset               payment;
   ...
   typedef roxe::multi_index< "cpuloan"_n, rex_loan,
   ...
   typedef roxe::multi_index< "netloan"_n, rex_loan,
                               indexed_by<"byexpr"_n,  const_mem_fun<rex_loan, uint64_t, &rex_loan::by_expr>>,
                               indexed_by<"byowner"_n, const_mem_fun<rex_loan, uint64_t, &rex_loan::by_owner>>
                             > rex_net_loan_table;

   struct [[roxe::table,roxe::contract("roxe.system")]] rex_order {
      uint8_t             version = 0;
      name                owner;
      asset               rex_requested;
      asset               proceeds;
      asset               stake_change;
      roxe::time_point   order_time;
      bool                is_open = true;
   ...
   typedef roxe::multi_index< "rexqueue"_n, rex_order,
   ...
   /**
    * The ROXE system contract. The ROXE system contract governs ram market, voters, producers, global state.
    */
   class [[roxe::contract("roxe.system")]] system_contract : public native {
      ...
      private:
         ...
         roxe_global_state       _gstate;
         roxe_global_state2      _gstate2;
         roxe_global_state3      _gstate3;
         roxe_global_state4      _gstate4;
      ...
      public:
         ...
         static constexpr roxe::name ram_account{"roxe.ram"_n};
         static constexpr roxe::name ramfee_account{"roxe.ramfee"_n};
         static constexpr roxe::name stake_account{"roxe.stake"_n};
         static constexpr roxe::name bpay_account{"roxe.bpay"_n};
         static constexpr roxe::name vpay_account{"roxe.vpay"_n};
         static constexpr roxe::name names_account{"roxe.names"_n};
         static constexpr roxe::name saving_account{"roxe.saving"_n};
         static constexpr roxe::name rex_account{"roxe.rex"_n};
         static constexpr roxe::name null_account{"roxe.null"_n};
         ...
         static symbol get_core_symbol( name system_account = "roxe"_n ) {
          ...
          */
         [[roxe::action]]
         void activate( const roxe::checksum256& feature_digest );

         // functions defined in delegate_bandwidth.cpp

         /**
          * Delegate bandwidth and/or cpu action. Stakes ROC from the balance of `from` for the benefit of `receiver`.
          *
         ...
         /**
          * Rentcpu action. Use payment to rent as many ROC tokens as possible as determined by market price and
         ...
         /**
          * Rentnet action. Use payment to rent as many ROC tokens as possible as determined by market price and
          ...
          * @pre Voter must have previously staked some ROXE for voting
...
//         void voteproducer( const name& voter, const name& proxy, const std::vector<name>& producers );
          ...
          */
         [[roxe::action]]
         void setparams( const roxe::blockchain_parameters& params );
          ...
          *     The remaining inflation will be sent to the `roxe.saving` account.
         ...
         using init_action = roxe::action_wrapper<"init"_n, &system_contract::init>;
         using setacctram_action = roxe::action_wrapper<"setacctram"_n, &system_contract::setacctram>;
         using setacctnet_action = roxe::action_wrapper<"setacctnet"_n, &system_contract::setacctnet>;
         using setacctcpu_action = roxe::action_wrapper<"setacctcpu"_n, &system_contract::setacctcpu>;
         using activate_action = roxe::action_wrapper<"activate"_n, &system_contract::activate>;
         using delegatebw_action = roxe::action_wrapper<"delegatebw"_n, &system_contract::delegatebw>;
         using deposit_action = roxe::action_wrapper<"deposit"_n, &system_contract::deposit>;
         using withdraw_action = roxe::action_wrapper<"withdraw"_n, &system_contract::withdraw>;
         using buyrex_action = roxe::action_wrapper<"buyrex"_n, &system_contract::buyrex>;
         using unstaketorex_action = roxe::action_wrapper<"unstaketorex"_n, &system_contract::unstaketorex>;
         using sellrex_action = roxe::action_wrapper<"sellrex"_n, &system_contract::sellrex>;
         using cnclrexorder_action = roxe::action_wrapper<"cnclrexorder"_n, &system_contract::cnclrexorder>;
         using rentcpu_action = roxe::action_wrapper<"rentcpu"_n, &system_contract::rentcpu>;
         using rentnet_action = roxe::action_wrapper<"rentnet"_n, &system_contract::rentnet>;
         using fundcpuloan_action = roxe::action_wrapper<"fundcpuloan"_n, &system_contract::fundcpuloan>;
         using fundnetloan_action = roxe::action_wrapper<"fundnetloan"_n, &system_contract::fundnetloan>;
         using defcpuloan_action = roxe::action_wrapper<"defcpuloan"_n, &system_contract::defcpuloan>;
         using defnetloan_action = roxe::action_wrapper<"defnetloan"_n, &system_contract::defnetloan>;
         using updaterex_action = roxe::action_wrapper<"updaterex"_n, &system_contract::updaterex>;
         using rexexec_action = roxe::action_wrapper<"rexexec"_n, &system_contract::rexexec>;
         using setrex_action = roxe::action_wrapper<"setrex"_n, &system_contract::setrex>;
         using mvtosavings_action = roxe::action_wrapper<"mvtosavings"_n, &system_contract::mvtosavings>;
         using mvfrsavings_action = roxe::action_wrapper<"mvfrsavings"_n, &system_contract::mvfrsavings>;
         using consolidate_action = roxe::action_wrapper<"consolidate"_n, &system_contract::consolidate>;
         using closerex_action = roxe::action_wrapper<"closerex"_n, &system_contract::closerex>;
         using undelegatebw_action = roxe::action_wrapper<"undelegatebw"_n, &system_contract::undelegatebw>;
         using buyram_action = roxe::action_wrapper<"buyram"_n, &system_contract::buyram>;
         using buyrambytes_action = roxe::action_wrapper<"buyrambytes"_n, &system_contract::buyrambytes>;
         using sellram_action = roxe::action_wrapper<"sellram"_n, &system_contract::sellram>;
         using refund_action = roxe::action_wrapper<"refund"_n, &system_contract::refund>;
         using regproducer_action = roxe::action_wrapper<"regproducer"_n, &system_contract::regproducer>;
         using unregprod_action = roxe::action_wrapper<"unregprod"_n, &system_contract::unregprod>;
         using setram_action = roxe::action_wrapper<"setram"_n, &system_contract::setram>;
         using setramrate_action = roxe::action_wrapper<"setramrate"_n, &system_contract::setramrate>;
//         using voteproducer_action = roxe::action_wrapper<"voteproducer"_n, &system_contract::voteproducer>;
         using regproxy_action = roxe::action_wrapper<"regproxy"_n, &system_contract::regproxy>;
         using claimrewards_action = roxe::action_wrapper<"claimrewards"_n, &system_contract::claimrewards>;
         using rmvproducer_action = roxe::action_wrapper<"rmvproducer"_n, &system_contract::rmvproducer>;
         using updtrevision_action = roxe::action_wrapper<"updtrevision"_n, &system_contract::updtrevision>;
         using bidname_action = roxe::action_wrapper<"bidname"_n, &system_contract::bidname>;
         using bidrefund_action = roxe::action_wrapper<"bidrefund"_n, &system_contract::bidrefund>;
         using setpriv_action = roxe::action_wrapper<"setpriv"_n, &system_contract::setpriv>;
         using setalimits_action = roxe::action_wrapper<"setalimits"_n, &system_contract::setalimits>;
         using setparams_action = roxe::action_wrapper<"setparams"_n, &system_contract::setparams>;
         using setinflation_action = roxe::action_wrapper<"setinflation"_n, &system_contract::setinflation>;
      ...
      private:
         ...
         //defined in roxe.system.cpp
         static roxe_global_state get_default_parameters();
         static roxe_global_state4 get_default_inflation_parameters();
