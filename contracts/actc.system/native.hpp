...
namespace actcsystem {
   ...
   struct authority {
      ...
      // explicit serialization macro is not necessary, used here only to improve compilation time
      actcLIB_SERIALIZE( authority, (threshold)(delay_sec)(keys)(accounts) )
   };
   ...
   struct block_header {
      ...
      actc::optional<actc::producer_schedule> new_producers;
    ...
    */
   class native : public actc::contract {
      public:
