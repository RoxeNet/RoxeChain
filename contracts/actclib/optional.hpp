   ...
   class optional {
      public:
         ...
         */
          ...
          */
         T&       operator*()      { actc_assert(_valid, "dereference of empty optional"); return ref(); }
          ...
          * @return T& - Contained value
          */
         const T& operator*()const { actc_assert(_valid, "dereference of empty optional"); return ref(); }
         ...
         T*       operator->()
         {
            actc_assert(_valid, "dereference of empty optional");
            return ptr();
         }
         ...
         *  @return actc::datastream<Stream>& - Reference to the datastream
         */
         template<typename Stream>
         friend inline actc::datastream<Stream>& operator>> (actc::datastream<Stream>& ds, optional& op)
         {
            char valid = 0;
            ds >> valid;
            if (valid) {
         ...
         */
         template<typename Stream>
         friend inline actc::datastream<Stream>& operator<< (actc::datastream<Stream>& ds, const optional& op)
         {
