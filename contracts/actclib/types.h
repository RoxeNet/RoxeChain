 ...
 * @details actc Public Key. It is 34 bytes.
 */
struct public_key {
   char data[34];
};
 ...
 * @details actc Signature. It is 66 bytes.
 */
struct signature {
   uint8_t data[66];
};
...
/**
 * @brief Type of actc Transaction Id
 * @details Type of actc Transaction Id. It is 256-bit hash
 */
