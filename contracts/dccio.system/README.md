...
## dccio.system::cfgproducer    account config
...
## dccio.system::okproducer     account producer vote
...
## dccio.system::setproxy       account proxy
...
## dccio.system::unstake        account quantity 
...
## dccio.system::withdraw account
   - this action can only be triggered by dccio.system via a deferred transaction generated by unstake
   - this will generate an inline dccio.token::transfer call from=dccio.system to=account and amount equal to the next withdraw increment
   - this will generate another deferred withdraw to continue the process if there are still withdraws to be made


## dccio.system::transfer from to amount memo
   - decrements balance of from if amount <= balance
   - increments balance of to by amount
   - memo is ignored 

## dccio.system::stakevote account amount
   - the primary currency of dccio is controlled by the token contract which enables users to transfer
...
## dccio.system::onblock   account blocktime blocknum
...
## dccio.system::freeze producer accounts true|false 
...
## dccio.system::paystandby producer
