...
namespace dcciosystem {
   ...
   struct permission_level_weight {
      ...
      dccLIB_SERIALIZE( permission_level_weight, (permission)(weight) )
   };
   ...
   struct key_weight {
      ...
      // explicit serialization macro is not necessary, used here only to improve compilation time
      dccLIB_SERIALIZE( key_weight, (key)(weight) )
   };
   ...
   struct authority {
      ...
      // explicit serialization macro is not necessary, used here only to improve compilation time
      dccLIB_SERIALIZE( authority, (threshold)(delay_sec)(keys)(accounts) )
   };
   ...
   struct block_header {
      ...
      dccio::optional<dccio::producer_schedule> new_producers;

      // explicit serialization macro is not necessary, used here only to improve compilation time
      dccLIB_SERIALIZE(block_header, (timestamp)(producer)(confirmed)(previous)(transaction_mroot)(action_mroot)
    ...
    */
   class native : public dccio::contract {
      public:
