...
#ifdef DISABLE_dccLIB_SERIALIZE
#include <dcciolib/serialize.hpp>
#undef dccLIB_SERIALIZE
#define dccLIB_SERIALIZE(...)
#endif
...
struct u128_action {
  ...
  dccLIB_SERIALIZE( u128_action, (values) )
};
...
struct cf_action {
   ...
   dccLIB_SERIALIZE( cf_action, (payload)(cfd_idx) )
};
...
struct dtt_action {
   ...
   dccLIB_SERIALIZE( dtt_action, (payer)(deferred_account)(deferred_action)(permission_name)(delay_sec) )
};
...
struct invalid_access_action {
   ...
   dccLIB_SERIALIZE( invalid_access_action, (code)(val)(index)(store) )
};
