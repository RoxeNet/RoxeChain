...
namespace  dccio {
    ...
    *  @brief Defines dccIO Singleton Table
    *  @ingroup databasecpp 
    *  @{
    */
   ...
   class singleton
   {
      ...
      struct row {
         ...
         dccLIB_SERIALIZE( row, (value) )
      };

      typedef dccio::multi_index<SingletonName, row> table;
      ...
      public:
         ...
         T get() {
            ...
            dccio_assert( itr != _t.end(), "singleton does not exist" );
            return itr->value;
         }
