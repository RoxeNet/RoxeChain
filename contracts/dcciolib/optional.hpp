   ...
   class optional {
      public:
         ...
         */
          ...
          */
         T&       operator*()      { dccio_assert(_valid, "dereference of empty optional"); return ref(); }
          ...
          * @return T& - Contained value
          */
         const T& operator*()const { dccio_assert(_valid, "dereference of empty optional"); return ref(); }
         ...
         T*       operator->()
         {
            dccio_assert(_valid, "dereference of empty optional");
            return ptr();
         }
         ...
         *  @return dccio::datastream<Stream>& - Reference to the datastream
         */
         template<typename Stream>
         friend inline dccio::datastream<Stream>& operator>> (dccio::datastream<Stream>& ds, optional& op)
         {
            char valid = 0;
            ds >> valid;
            if (valid) {
         ...
         */
         template<typename Stream>
         friend inline dccio::datastream<Stream>& operator<< (dccio::datastream<Stream>& ds, const optional& op)
         {
