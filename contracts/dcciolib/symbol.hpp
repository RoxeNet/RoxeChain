#pragma once
#include <dcciolib/core_symbol.hpp>
...
namespace dccio {
   ...
   */
    ...
    * @param str - the string representation of the symbol
    */
   #define S(P,X) ::dccio::string_to_symbol(P,#X)
   ...
   struct symbol_type {
      ...
      */
      ...
      dccLIB_SERIALIZE( symbol_type, (value) )
   };
   ...
   struct extended_symbol : public symbol_type
   {
     ...
     extended_symbol( symbol_name sym = 0, account_name acc = 0 ):symbol_type{sym},contract(acc){}
      ...
      dccLIB_SERIALIZE( extended_symbol, (value)(contract) )
   };
