...
/**
 * @brief dccIO Public Key
 * @details dccIO Public Key. It is 34 bytes.
 */
struct public_key {
   char data[34];
};
...
/**
 * @brief dccIO Signature
 * @details dccIO Signature. It is 66 bytes.
 */
struct signature {
   uint8_t data[66];
};
...
/**
 * @brief Type of dccIO Transaction Id
 * @details Type of dccIO Transaction Id. It is 256-bit hash
 */
