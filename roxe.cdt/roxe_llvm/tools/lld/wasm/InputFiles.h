...
public:
  ...
  std::string getRoxeABI() const { return roxe_abi; }
  ArrayRef<StringRef> getRoxeActions() const { return roxe_actions; }
  ArrayRef<StringRef> getRoxeNotify() const { return roxe_notify; }
private:
  std::string roxe_abi;
  ArrayRef<StringRef> roxe_actions;
  ArrayRef<StringRef> roxe_notify;
