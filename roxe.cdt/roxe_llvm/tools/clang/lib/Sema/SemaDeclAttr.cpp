...
static void handleRoxeRicardianAttribute(Sema &S, Decl *D, const AttributeList &AL) {
  ...
  if (AL.isArgExpr(0) && AL.getArgAsExpr(0) &&
   ...
   D->addAttr(::new (S.Context)
                 RoxeRicardianAttr(AL.getRange(), S.Context, Str,
                                AL.getAttributeSpellingListIndex()));
}

static void handleRoxeNotifyAttribute(Sema &S, Decl *D, const AttributeList &AL) {
  // Handle the cases where the attribute has a text message.
  StringRef Str, Replacement;
  if (AL.isArgExpr(0) && AL.getArgAsExpr(0) &&
      !S.checkStringLiteralArgumentAttr(AL, 0, Str))
   ...
   D->addAttr(::new (S.Context)
                 RoxeNotifyAttr(AL.getRange(), S.Context, Str,
                                AL.getAttributeSpellingListIndex()));
}

static void handleRoxeContractAttribute(Sema &S, Decl *D, const AttributeList &AL) {
  // Handle the cases where the attribute has a text message.
  StringRef Str, Replacement;
  if (AL.isArgExpr(0) && AL.getArgAsExpr(0) &&
      !S.checkStringLiteralArgumentAttr(AL, 0, Str))
    return;
  D->addAttr(::new (S.Context)
                 RoxeContractAttr(AL.getRange(), S.Context, Str,
                                AL.getAttributeSpellingListIndex()));
}

static void handleRoxeABIAttribute(Sema &S, Decl *D, const AttributeList &AL) {
  // Handle the cases where the attribute has a text message.
  StringRef Str, Replacement;
  if (AL.isArgExpr(0) && AL.getArgAsExpr(0) &&
      !S.checkStringLiteralArgumentAttr(AL, 0, Str))
  ...
  D->addAttr(::new (S.Context)
                 RoxeWasmABIAttr(AL.getRange(), S.Context, Str,
                                AL.getAttributeSpellingListIndex()));
}

static void handleRoxeWasmActionAttribute(Sema &S, Decl *D, const AttributeList &AL) {
  // Handle the cases where the attribute has a text message.
  StringRef Str, Replacement;
  if (AL.isArgExpr(0) && AL.getArgAsExpr(0) &&
      !S.checkStringLiteralArgumentAttr(AL, 0, Str))
  ...
  D->addAttr(::new (S.Context)
                 RoxeWasmActionAttr(AL.getRange(), S.Context, Str,
                                AL.getAttributeSpellingListIndex()));
}

static void handleRoxeWasmNotifyAttribute(Sema &S, Decl *D, const AttributeList &AL) {
  // Handle the cases where the attribute has a text message.
  StringRef Str, Replacement;
  if (AL.isArgExpr(0) && AL.getArgAsExpr(0) &&
      !S.checkStringLiteralArgumentAttr(AL, 0, Str))
  ...
  D->addAttr(::new (S.Context)
                 RoxeWasmNotifyAttr(AL.getRange(), S.Context, Str,
                                AL.getAttributeSpellingListIndex()));
}

static void handleRoxeActionAttribute(Sema &S, Decl *D, const AttributeList &AL) {
  // Handle the cases where the attribute has a text message.
  StringRef Str, Replacement;
  if (AL.isArgExpr(0) && AL.getArgAsExpr(0) &&
      !S.checkStringLiteralArgumentAttr(AL, 0, Str))
  ...
  D->addAttr(::new (S.Context)
                 RoxeActionAttr(AL.getRange(), S.Context, Str,
                                AL.getAttributeSpellingListIndex()));
}

static void handleRoxeTableAttribute(Sema &S, Decl *D, const AttributeList &AL) {
  // Handle the cases where the attribute has a text message.
  StringRef Str, Replacement;
  if (AL.isArgExpr(0) && AL.getArgAsExpr(0) &&
      !S.checkStringLiteralArgumentAttr(AL, 0, Str))
  ...
  D->addAttr(::new (S.Context)
                 RoxeTableAttr(AL.getRange(), S.Context, Str,
                                AL.getAttributeSpellingListIndex()));
}
...
static void ProcessDeclAttribute(Sema &S, Scope *scope, Decl *D,
  ...
  default:
    ...
    break;
  case AttributeList::AT_RoxeWasmImport:
    handleSimpleAttribute<RoxeWasmImportAttr>(S, D, AL);
    break;
  case AttributeList::AT_RoxeWasmEntry:
    handleSimpleAttribute<RoxeWasmEntryAttr>(S, D, AL);
    break;
  case AttributeList::AT_RoxeIgnore:
    handleSimpleAttribute<RoxeIgnoreAttr>(S, D, AL);
    break;
  case AttributeList::AT_RoxeAction:
    handleRoxeActionAttribute(S, D, AL);
    break;
  case AttributeList::AT_RoxeTable:
    handleRoxeTableAttribute(S, D, AL);
    break;
  case AttributeList::AT_RoxeWasmABI:
    handleRoxeABIAttribute(S, D, AL);
    break;
  case AttributeList::AT_RoxeWasmAction:
    handleRoxeWasmActionAttribute(S, D, AL);
    break;
  case AttributeList::AT_RoxeWasmNotify:
    handleRoxeWasmNotifyAttribute(S, D, AL);
    break;
  case AttributeList::AT_RoxeContract:
    handleRoxeContractAttribute(S, D, AL);
    break;
  case AttributeList::AT_RoxeRicardian:
    handleRoxeRicardianAttribute(S, D, AL);
    break;
  case AttributeList::AT_RoxeNotify:
    handleRoxeNotifyAttribute(S, D, AL);
    break;
