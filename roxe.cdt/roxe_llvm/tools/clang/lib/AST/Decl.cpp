...
bool RecordDecl::isRoxeIgnore() const { return hasAttr<RoxeIgnoreAttr>(); }
...
bool FunctionDecl::isRoxeWasmABI()const { return hasAttr<RoxeWasmABIAttr>(); }
std::string FunctionDecl::getWasmABI()const { return getAttr<RoxeWasmABIAttr>()->getAbi(); }
bool FunctionDecl::isRoxeWasmEntry()const { return hasAttr<RoxeWasmEntryAttr>(); }
bool FunctionDecl::isRoxeWasmImport()const { return hasAttr<RoxeWasmImportAttr>(); }
bool FunctionDecl::isRoxeWasmAction()const { return hasAttr<RoxeWasmActionAttr>(); }
std::string FunctionDecl::getRoxeWasmAction()const { return getAttr<RoxeWasmActionAttr>()->getName(); }
bool FunctionDecl::isRoxeWasmNotify()const { return hasAttr<RoxeWasmNotifyAttr>(); }
std::string FunctionDecl::getRoxeWasmNotify()const { return getAttr<RoxeWasmNotifyAttr>()->getName(); }
