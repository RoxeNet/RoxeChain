...
public:
  ...
  bool isRoxeContract() const { return hasAttr<RoxeContractAttr>(); }
  bool isRoxeAction() const { return hasAttr<RoxeActionAttr>(); }
  bool isRoxeTable() const { return hasAttr<RoxeTableAttr>(); }
  bool isRoxeIgnore() const { return hasAttr<RoxeIgnoreAttr>(); }
  bool hasRoxeRicardian() const { return hasAttr<RoxeRicardianAttr>(); }
  RoxeActionAttr* getRoxeActionAttr() const { return getAttr<RoxeActionAttr>(); }
  RoxeTableAttr*  getRoxeTableAttr() const { return getAttr<RoxeTableAttr>(); }
  RoxeContractAttr*  getRoxeContractAttr() const { return getAttr<RoxeContractAttr>(); }
  RoxeRicardianAttr*  getRoxeRicardianAttr() const { return getAttr<RoxeRicardianAttr>(); }
...
public:
  ...
  bool isRoxeAction() const { return hasAttr<RoxeActionAttr>(); }
  bool isRoxeNotify() const { return hasAttr<RoxeNotifyAttr>(); }
  bool isRoxeContract() const { return hasAttr<RoxeContractAttr>(); }
  bool hasRoxeRicardian() const { return hasAttr<RoxeRicardianAttr>(); }
  RoxeActionAttr* getRoxeActionAttr() const { return getAttr<RoxeActionAttr>(); }
  RoxeNotifyAttr* getRoxeNotifyAttr() const { return getAttr<RoxeNotifyAttr>(); }
  RoxeContractAttr* getRoxeContractAttr() const { return getAttr<RoxeContractAttr>(); }
  RoxeRicardianAttr* getRoxeRicardianAttr() const { return getAttr<RoxeRicardianAttr>(); }
