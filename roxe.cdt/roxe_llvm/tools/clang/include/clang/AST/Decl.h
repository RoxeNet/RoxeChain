...
public:
  ...
  bool isRoxeWasmABI()const;
  std::string getWasmABI()const;
  bool isRoxeWasmEntry()const;
  bool isRoxeWasmImport()const;
  bool isRoxeWasmAction()const;
  std::string getRoxeWasmAction()const;
  bool isRoxeWasmNotify()const;
  std::string getRoxeWasmNotify()const;
