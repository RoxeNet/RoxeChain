### Usage
---
To manually compile the source code, use `roxe-cpp/roxe-cc` and `roxe-ld` as if it were __clang__ and __lld__. All the includes and options specific to ROXE and CDT are baked in.

###$ roxe-cpp
---
```
USAGE: roxe-cpp [options] <input file> ...
