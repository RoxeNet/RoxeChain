...
// Definitions in `roxe.cdt/libraries/roxe/symbol.hpp`
ROXE_TEST_BEGIN(symbol_code_type_test)
...
// Definitions in `roxe.cdt/libraries/roxe/symbol.hpp`
ROXE_TEST_BEGIN(symbol_type_test)
...
// Definitions in `roxe.cdt/libraries/roxe/symbol.hpp`
ROXE_TEST_BEGIN(extended_symbol_type_test)
...
int main(int argc, char* argv[]) {
   ...
   ROXE_TEST(symbol_code_type_test);
   ROXE_TEST(symbol_type_test);
   ROXE_TEST(extended_symbol_type_test);
   return has_failed();
}
