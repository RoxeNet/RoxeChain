...
struct D1 : public B {
   const int i{};
   ROXELIB_SERIALIZE_DERIVED( D1, B, (i) )
...
struct D2 : public D1 {
   ...
   ROXELIB_SERIALIZE_DERIVED( D2, D1, (v) )
...
// Definitions in `roxe.cdt/libraries/roxe/serialize.hpp`
ROXE_TEST_BEGIN(serialize_test)
