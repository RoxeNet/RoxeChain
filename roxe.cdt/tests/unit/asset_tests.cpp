...
using roxe::name;
using roxe::symbol;
using roxe::extended_symbol;
using roxe::asset;
using roxe::extended_asset;
...
// Definitions in `roxe.cdt/libraries/roxe/asset.hpp`
ROXE_TEST_BEGIN(asset_type_test)
...
// Definitions in `roxe.cdt/libraries/roxe/asset.hpp`
ROXE_TEST_BEGIN(extended_asset_type_test)
   static constexpr symbol sym_no_prec{"SYMBOLL",0};
   static constexpr symbol sym_prec{"SYMBOLL",63};

   static constexpr extended_symbol ext_sym_no_prec{sym_no_prec, name{"roxeaccountj"}};
   static constexpr extended_symbol ext_sym_prec{sym_prec, name{"roxeaccountj"}};
   ...
   CHECK_EQUAL( (extended_asset{{},ext_sym_no_prec}.contract), (name{"roxeaccountj"}) )

   //// extended_asset(asset, name)
   CHECK_EQUAL( (extended_asset{asset_no_prec, name{"roxeaccountj"}}.quantity), (asset{ 0LL, sym_no_prec}) )
   CHECK_EQUAL( (extended_asset{asset_no_prec, name{"roxeaccountj"}}.contract), (name{"roxeaccountj"}) )
   ...
   CHECK_ASSERT( "type mismatch", (
      [&]() {
         extended_asset{asset_no_prec, name{"roxeaccountj"}} + extended_asset{asset_no_prec, name{"jtnuoccaoisoe"}};
      })
   )
   ...
   CHECK_ASSERT( "type mismatch", (
      [&]() {
         temp += extended_asset{asset_no_prec, name{"roxeaccountj"}};
      })
   )
   ...
   // --------------------------------------------------------------------
   // friend bool operator!=(const extended_asset&, const extended_asset&)
   CHECK_EQUAL( (extended_asset{asset_no_prec, name{"roxeaccountj"}} != extended_asset{asset_no_prec, name{"jtnuoccaoisoe"}}), true )
   CHECK_EQUAL( (extended_asset{asset{1LL, sym_no_prec}, {}} != extended_asset{asset{-1LL, sym_no_prec}, {}}), true )
   CHECK_EQUAL( (extended_asset{asset{1LL, sym_no_prec}, {}} != extended_asset{asset{ 0LL, sym_no_prec}, name{"roxeaccountj"}}), true )
   ...
   CHECK_ASSERT( "type mismatch", (
      [&]() {
         bool b{extended_asset{{}, name{}} < extended_asset{{}, name{"roxeaccountj"}}};
         return b;
      })
   )
...
int main(int argc, char* argv[]) {
   ...
   ROXE_TEST(asset_type_test);
   ROXE_TEST(extended_asset_type_test);
   return has_failed();
}
