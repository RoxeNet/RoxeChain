...
// Definitions in `roxe.cdt/libraries/roxe/name.hpp`
ROXE_TEST_BEGIN(name_type_test)
   //// constexpr name()
   ...
   CHECK_EQUAL( name{"roxe"}.length(), 3 )
   CHECK_EQUAL( name{"roxei"}.length(), 4 )
   CHECK_EQUAL( name{"roxe"}.length(), 5 )
   CHECK_EQUAL( name{"roxea"}.length(), 6 )
   CHECK_EQUAL( name{"roxeac"}.length(), 7 )
   CHECK_EQUAL( name{"roxeacc"}.length(), 8 )
   CHECK_EQUAL( name{"roxeacco"}.length(), 9 )
   CHECK_EQUAL( name{"roxeaccou"}.length(), 10 )
   CHECK_EQUAL( name{"roxeaccoun"}.length(), 11 )
   CHECK_EQUAL( name{"roxeaccount"}.length(), 12 )
   CHECK_EQUAL( name{"roxeaccountj"}.length(), 13 )
