...
// Defined in `roxe.cdt/libraries/roxe/varint.hpp`
ROXE_TEST_BEGIN(unsigned_int_type_test)
...
// Defined in `roxe.cdt/libraries/roxe/varint.hpp`
ROXE_TEST_BEGIN(signed_int_type_test)
   //// signed_int(uint32_t)
...
int main(int argc, char* argv[]) {
   ...
   ROXE_TEST(unsigned_int_type_test)
   ROXE_TEST(signed_int_type_test);
   return has_failed();
}
