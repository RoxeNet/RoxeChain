if(ROXE_CDT_ROOT STREQUAL "" OR NOT ROXE_CDT_ROOT)
   set(ROXE_CDT_ROOT "@CDT_ROOT_DIR@")
endif()

list(APPEND CMAKE_MODULE_PATH ${ROXE_CDT_ROOT}/lib/cmake/roxe.cdt)
if (NOT ROXE_WASM_OLD_BEHAVIOR STREQUAL "Off")
    set(ROXE_WASM_OLD_BEHAVIOR "On")
    include(RoxeWasmToolchain)
endif()

include(RoxeCDTMacros)
...
function(ROXE_CHECK_VERSION output version hard_min soft_max hard_max) # optional 6th argument for error message
...
endfunction(ROXE_CHECK_VERSION)
