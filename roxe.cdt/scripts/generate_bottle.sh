...
mkdir -p ${PROJECT}/${VERSION}/opt/roxe_cdt/lib/cmake
...
echo "class RoxeCdt < Formula

   homepage \"${URL}\"
   revision 0
   url \"https://github.com/roxe/roxe.cdt/archive/v${VERSION}.tar.gz\"
   version \"${VERSION}\"
   ...
   bottle do
      root_url \"https://github.com/roxe/roxe.cdt/releases/download/v${VERSION}\"
