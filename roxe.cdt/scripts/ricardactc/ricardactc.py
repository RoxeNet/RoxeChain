...
def main():
    if len(sys.argv) == 1:
        print('Please specify an operation of export or import: ./ricardroxe.py <import|export>')
        sys.exit(1)

    if sys.argv[1] == 'import':
        if len(sys.argv) < 4:
            print('Please specify a source and destination abi:')
            print('Usage: ./ricardroxe.py import /roxe/contracts/contract/mycontract.abi /roxe/contracts/contract/withricardian-mycontract.abi')
        ...
        if len(sys.argv) < 3:
            ...
            print('Usage: ./ricardroxe.py export /roxe/contracts/contract/mycontract.abi')
