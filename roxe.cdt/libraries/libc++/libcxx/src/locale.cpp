...
extern "C" void roxe_assert(bool, const char*);
size_t strftime(char*, size_t, const char*, const struct tm*) { roxe_assert(false, "strftime called"); }
size_t strftime_l(char*, size_t, const char*, const struct tm*, locale_t) { roxe_assert(false, "strftime_l called"); }
