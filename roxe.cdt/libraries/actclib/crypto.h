...
#warning "<roxelib/crypto.h> is deprecated use <roxe/crypto.h>. If you are using C++ the .h header files will be removed from inclusion entirely in v1.7.0"
 ...
 *  roxe::print("sha256 hash generated from data equals provided hash");
 *  @endcode
 */
 ...
 *  roxe::print("sha1 hash generated from data equals provided hash");
 *  @endcode
 */
__attribute__((roxe_wasm_import))
 ...
 *  roxe::print("sha512 hash generated from data equals provided hash");
 *  @endcode
 */
__attribute__((roxe_wasm_import))
 ...
 *  roxe::print("ripemod160 hash generated from data equals provided hash");
 *  @endcode
 */
__attribute__((roxe_wasm_import))
 ...
 *  roxe_assert( calc_hash == hash, "invalid hash" );
 *  @endcode
 */
__attribute__((roxe_wasm_import))
 ...
 *  roxe::print("pub key matches the pub key generated from digest");
 *  @endcode
 */
__attribute__((roxe_wasm_import))
