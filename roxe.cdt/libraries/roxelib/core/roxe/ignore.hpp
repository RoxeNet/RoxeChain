...
namespace roxe {
   ...
   inline DataStream& operator<<(DataStream& ds, const ::roxe::ignore_wrapper<T>& val) {
     ds << val.value;
     return ds;
   }
    ...
    */
   template<typename DataStream, typename T>
   inline DataStream& operator<<(DataStream& ds, const ::roxe::ignore<T>& val) {
     return ds;
   }
    ...
    */
   template<typename DataStream, typename T>
   inline DataStream& operator>>(DataStream& ds, ::roxe::ignore<T>&) {
     return ds;
   }
}
