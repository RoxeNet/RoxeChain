...
#warning "<roxelib/privileged.hpp> is deprecated use <roxe/privileged.hpp>"
namespace roxe {
   ...
   */
   ...
   struct blockchain_parameters {
      ...
      */
      ...
      ROXELIB_SERIALIZE( blockchain_parameters,
   ...
   */
   ...
   struct producer_key {
      ...
      ROXELIB_SERIALIZE( producer_key, (producer_name)(block_signing_key) )
   };
