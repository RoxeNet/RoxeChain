...
namespace roxe {
   ...
   roxe::public_key recover_key( const roxe::checksum256& digest, const roxe::signature& sig ) {
      ...
      char sig_data[70];
      roxe::datastream<char*> sig_ds( sig_data, sizeof(sig_data) );
      ...
      roxe::datastream<char*> pubkey_ds( pubkey_data, pubkey_size );
      roxe::public_key pubkey;
      pubkey_ds >> pubkey;
      return pubkey;
   }
   ...
   void assert_recover_key( const roxe::checksum256& digest, const roxe::signature& sig, const roxe::public_key& pubkey ) {
      ...
      char pubkey_data[38];
      roxe::datastream<char*> pubkey_ds( pubkey_data, sizeof(pubkey_data) );
