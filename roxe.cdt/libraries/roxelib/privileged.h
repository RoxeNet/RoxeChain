...
#warning "<roxelib/privileged.h> is deprecated use <roxe/privileged.h>. If you are using C++ the .h header files will be removed from inclusion entirely in v1.7.0"
