...
#warning "<roxelib/action.h> is deprecated use <roxe/action.h>. If you are using C++ the .h header files will be removed from inclusion entirely in v1.7.0"
...
extern "C" {
    ...
    *
    *
    * A ROXE action has the following abstract structure:
    *
    * ```
    *   struct action {
