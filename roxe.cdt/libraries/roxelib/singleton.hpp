...
#warning "<roxelib/singleton.hpp> is deprecated use <roxe/singleton.hpp>"
namespace  roxe {

   /**
    *  @defgroup singleton Singleton Table
    *  @ingroup contracts
    *  @brief Defines ROXE Singleton Table used with %multiindex
    *  @{
    */
   ...
   class singleton
   {
      ...
      struct row {
         ...
         ROXELIB_SERIALIZE( row, (value) )
      };

      typedef roxe::multi_index<SingletonName, row> table;
      ...
      public:
         ...
         T get() {
            ...
            roxe::check( itr != _t.end(), "singleton does not exist" );
            return itr->value;
         }
