...
#warning "<roxelib/contract.hpp> is deprecated use <roxe/contract.hpp>"

/**
 * @defgroup contract Contract
 * @ingroup types
 * @brief Defines contract type which is %base class for every ROXE contract
 * @{
 */
namespace roxe {

/**
 * @brief %Base class for ROXE contract.
 * @details %Base class for ROXE contract. %A new contract should derive from this class, so it can make use of ROXE_ABI macro.
 */
class contract {
   public:
      /**
