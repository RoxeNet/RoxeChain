...
#warning "<roxelib/symbol.hpp> is deprecated use <roxe/symbol.hpp>"
namespace roxe {
   ...
   */
   ...
   public:
      ...
      */
      ...
      friend inline DataStream& operator<<(DataStream& ds, const roxe::symbol_code sym_code) {
      ...
      */
      template<typename DataStream>
      friend inline DataStream& operator>>(DataStream& ds, roxe::symbol_code& sym_code) {
         uint64_t raw = 0;
