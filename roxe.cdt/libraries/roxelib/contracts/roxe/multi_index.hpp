...
#include "../../contracts/roxe/action.hpp"
#include "../../core/roxe/name.hpp"
#include "../../core/roxe/serialize.hpp"
#include "../../core/roxe/fixed_bytes.hpp"
...
class multi_index
{
   ...
   public:
      ...
      const_iterator emplace( name payer, Lambda&& constructor ) {
         ...
         roxe::check( _code == current_receiver(), "cannot create objects in table of another contract" ); // Quick fix for mutating db using multi_index that shouldn't allow mutation. Real fix can come in RC2.
      ...
      void modify( const T& obj, name payer, Lambda&& updater ) {
         ...
         roxe::check( _code == current_receiver(), "cannot modify objects in table of another contract" ); // Quick fix for mutating db using multi_index that shouldn't allow mutation. Real fix can come in RC2.
      ...
      void erase( const T& obj ) {
         ...
         roxe::check( _code == current_receiver(), "cannot erase objects in table of another contract" ); // Quick fix for mutating db using multi_index that shouldn't allow mutation. Real fix can come in RC2.
