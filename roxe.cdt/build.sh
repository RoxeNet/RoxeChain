...
if [[ "${unamestr}" == 'Darwin' ]]; then
   ...
   CXX_COMPILER=g++
   export ARCH="Darwin"
   bash ./scripts/roxe_build_darwin.sh
else
   ...
   case "$OS_NAME" in
      "Amazon Linux AMI")
         ...
         bash ./scripts/roxe_build_amazon.sh
         ;;
      "CentOS Linux")
         export ARCH="Centos"
         export CMAKE=${HOME}/opt/cmake/bin/cmake
         bash ./scripts/roxe_build_centos.sh
         ;;
      "elementary OS")
         export ARCH="elementary OS"
         bash ./scripts/roxe_build_ubuntu.sh
         ;;
      "Fedora")
         export ARCH="Fedora"
         bash ./scripts/roxe_build_fedora.sh
         ;;
      "Linux Mint")
...
printf "\\tROXE website: https://eos.io\\n"
