...
def main():
    if len(sys.argv) == 1:
        print('Please specify an operation of export or import: ./ricardactc.py <import|export>')
        sys.exit(1)

    if sys.argv[1] == 'import':
        if len(sys.argv) != 4:
            print('Please specify a source and destination abi:')
            print('Usage: ./ricardactc.py import /actc/contracts/contract/mycontract.abi /actc/contracts/contract/withricardian-mycontract.abi')
        ...
        if len(sys.argv) != 3:
            ...
            print('Usage: ./ricardactc.py export /actc/contracts/contract/mycontract.abi')
