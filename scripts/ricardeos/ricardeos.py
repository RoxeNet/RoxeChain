...
def main():
    if len(sys.argv) == 1:
        print('Please specify an operation of export or import: ./ricarddcc.py <import|export>')
        sys.exit(1)

    if sys.argv[1] == 'import':
        if len(sys.argv) != 4:
            print('Please specify a source and destination abi:')
            print('Usage: ./ricarddcc.py import /dcc/contracts/contract/mycontract.abi /dcc/contracts/contract/withricardian-mycontract.abi')
        ...
        if len(sys.argv) != 3:
            ...
            print('Usage: ./ricarddcc.py export /dcc/contracts/contract/mycontract.abi')
